...
const $b5a2e2520da70a0e$var$id = "#screen2";
function $b5a2e2520da70a0e$export$f22da7240b7add18() {
    document.querySelector(`${$b5a2e2520da70a0e$var$id} button`).addEventListener("click", ()=>{
...
(0, $ix1dx.onDomReady)($b5a2e2520da70a0e$export$f22da7240b7add18);
