...
})({"l5KPM":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "329d810b796f6949";
"use strict";
...
},{}],"5QU0n":[function(require,module,exports) {
...
const id = "#screen9";
function main() {
    const innerRef = (0, _dom.el)("#screen9");
    const scrollTrigger = (0, _state.getState)().scrollTriggers[`screen9Enter`];
    ...
    const onMouseEnter = (id)=>{
        const tl = (0, _gsap.gsap).timeline({}).fromTo(`.arrow2-${id}`, {
            x: -20,
            y: 0,
            duration: 0.5,
            ease: "power4.Out"
    ...
    (0, _gsap.gsap).context(()=>{
        ...
        (0, _gsap.gsap).utils.toArray(".projectBlock").forEach((item, index)=>{
...
},{"../utils/utils":"ea5wt","../state/state":"8LIzr","gsap":"fPSuC","../utils/dom":"8THqZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l5KPM","5QU0n"], "5QU0n", "parcelRequireb921")

//# sourceMappingURL=index.796f6949.js.map
