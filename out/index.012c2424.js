...
$parcel$export(module.exports, "height", function () { return $f9c3f774c17381db$export$ac607276a8fe9f0a; });
$parcel$export(module.exports, "calcOverflowOffset", function () { return $f9c3f774c17381db$export$95227ead4e4cbbd; });
$parcel$export(module.exports, "getRandomInt", function () { return $f9c3f774c17381db$export$b141de964f0a90c1; });
$parcel$export(module.exports, "isTouchDevice", function () { return $f9c3f774c17381db$export$a1d0d20ee9546562; });
function $f9c3f774c17381db$export$537b54b30f329b90(fn) {
    document.addEventListener("DOMContentLoaded", fn);
}
function $f9c3f774c17381db$export$ac607276a8fe9f0a(ref) {
    return ref.offsetHeight;
}
function $f9c3f774c17381db$export$7e3df82ee760448c(ref) {
    return ref.offsetWidth;
}
function $f9c3f774c17381db$export$dc81048565b75a98(ref) {
    return ref.scrollWidth;
}
function $f9c3f774c17381db$export$95227ead4e4cbbd(ref, viewport) {
    let h = $f9c3f774c17381db$export$ac607276a8fe9f0a(ref);
...
function $f9c3f774c17381db$export$61fc7d43ac8f84b0(callback, wait) {
    let timeoutId = null;
    return (...args)=>{
...
function $f9c3f774c17381db$export$41fb34e2d77e3aca() {
    let check = false;
    (function(a) {
...
function $f9c3f774c17381db$export$b141de964f0a90c1(max) {
    return Math.floor(Math.random() * max);
}
function $f9c3f774c17381db$export$a1d0d20ee9546562() {
    return "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0;
}

});

parcelRequire.register("gISqU", function(module, exports) {
...
parcelRequire.register("9eyNG", function(module, exports) {

$parcel$export(module.exports, "initSmoothScrollbar", function () { return $6b906a7d6d18f98e$export$5c67ce8f97fe3303; });

var $4qafb = parcelRequire("4qafb");

var $gISqU = parcelRequire("gISqU");

var $4h5Gm = parcelRequire("4h5Gm");

var $3XZr1 = parcelRequire("3XZr1");
function $6b906a7d6d18f98e$export$5c67ce8f97fe3303(topContainerRef, disabledFirst = true) {
    if (!document || !topContainerRef) return;
    (0, $4qafb.default).use((0, $4h5Gm.ScrollbarModalPlugin));
    (0, $4qafb.default).use((0, $3XZr1.ScrollbarScreenStopPlugin));
    const bodyScrollBar = (0, $4qafb.default).init(topContainerRef, {
        damping: 0.03,
        // delegateTo: document,
    ...
    (0, $gISqU.ScrollTrigger).scrollerProxy(topContainerRef, {
        scrollTop (value) {
            if (arguments.length) bodyScrollBar.scrollTop = value;
            return bodyScrollBar.scrollTop;
        }
    });
    bodyScrollBar.addListener((0, $gISqU.ScrollTrigger).update);
    (0, $gISqU.ScrollTrigger).defaults({
...
parcelRequire.register("4qafb", function(module, exports) {

$parcel$export(module.exports, "default", function () { return $33818957d53e536a$export$2e2bcd8739ae039; });
$parcel$export(module.exports, "ScrollbarPlugin", function () { return (parcelRequire("9SjjN")).ScrollbarPlugin; });

var $nn6O4 = parcelRequire("nn6O4");
parcelRequire("6LaRI");

var $axPtg = parcelRequire("axPtg");

var $9SjjN = parcelRequire("9SjjN");

var $fRyUO = parcelRequire("fRyUO");
/**
 ...
 */ var $33818957d53e536a$var$SmoothScrollbar = /** @class */ function(_super) {
    (0, $nn6O4.__extends)(SmoothScrollbar, _super);
     ...
     */ SmoothScrollbar.init = function(elem, options) {
        ...
        // attach stylesheet
        (0, $fRyUO.attachStyle)();
        if ((0, $axPtg.scrollbarMap).has(elem)) return (0, $axPtg.scrollbarMap).get(elem);
        return new (0, $axPtg.Scrollbar)(elem, options);
    };
    /**
     ...
     */ SmoothScrollbar.has = function(elem) {
        return (0, $axPtg.scrollbarMap).has(elem);
    };
    /**
     ...
     */ SmoothScrollbar.get = function(elem) {
        return (0, $axPtg.scrollbarMap).get(elem);
    };
    /**
     * Returns an array that contains all scrollbar instances
     */ SmoothScrollbar.getAll = function() {
        return Array.from((0, $axPtg.scrollbarMap).values());
    };
    /**
     * Removes scrollbar on the given element
     */ SmoothScrollbar.destroy = function(elem) {
        var scrollbar = (0, $axPtg.scrollbarMap).get(elem);
        if (scrollbar) scrollbar.destroy();
    };
    /**
     * Removes all scrollbar instances from current document
     */ SmoothScrollbar.destroyAll = function() {
        (0, $axPtg.scrollbarMap).forEach(function(scrollbar) {
            scrollbar.destroy();
        });
    };
    /**
     ...
     */ SmoothScrollbar.use = function() {
        ...
        return (0, $9SjjN.addPlugins).apply(void 0, Plugins);
    };
    /**
     ...
     */ SmoothScrollbar.attachStyle = function() {
        return (0, $fRyUO.attachStyle)();
    };
    /**
     * Removes default styles from current document.
     * Use this method when you want to use your own css for scrollbars.
     */ SmoothScrollbar.detachStyle = function() {
        return (0, $fRyUO.detachStyle)();
    };
    SmoothScrollbar.version = "8.8.1";
    SmoothScrollbar.ScrollbarPlugin = (0, $9SjjN.ScrollbarPlugin);
    return SmoothScrollbar;
}((0, $axPtg.Scrollbar));
var $33818957d53e536a$export$2e2bcd8739ae039 = $33818957d53e536a$var$SmoothScrollbar;

});
parcelRequire.register("nn6O4", function(module, exports) {

$parcel$export(module.exports, "__extends", function () { return $046413053845cee4$export$a8ba968b8961cb8a; });
$parcel$export(module.exports, "__assign", function () { return $046413053845cee4$export$18ce0697a983be9b; });
$parcel$export(module.exports, "__decorate", function () { return $046413053845cee4$export$29e00dfd3077644b; });
$parcel$export(module.exports, "__spreadArrays", function () { return $046413053845cee4$export$6388937ca91ccae8; });
/*! *****************************************************************************
...
***************************************************************************** */ /* global Reflect, Promise */ var $046413053845cee4$var$extendStatics = function(d, b) {
    $046413053845cee4$var$extendStatics = Object.setPrototypeOf || ({
        __proto__: []
    ...
    return $046413053845cee4$var$extendStatics(d, b);
};
function $046413053845cee4$export$a8ba968b8961cb8a(d, b) {
    $046413053845cee4$var$extendStatics(d, b);
    function __() {
        this.constructor = d;
    }
    d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
}
var $046413053845cee4$export$18ce0697a983be9b = function() {
    $046413053845cee4$export$18ce0697a983be9b = Object.assign || function __assign(t) {
    ...
    return $046413053845cee4$export$18ce0697a983be9b.apply(this, arguments);
};
function $046413053845cee4$export$3c9a16f847548506(s, e) {
    var t = {};
...
function $046413053845cee4$export$29e00dfd3077644b(decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for(var i = decorators.length - 1; i >= 0; i--)if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
}
function $046413053845cee4$export$d5ad3fd78186038f(paramIndex, decorator) {
    return function(target, key) {
        decorator(target, key, paramIndex);
    };
}
function $046413053845cee4$export$f1db080c865becb9(metadataKey, metadataValue) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(metadataKey, metadataValue);
}
function $046413053845cee4$export$1050f835b63b671e(thisArg, _arguments, P, generator) {
...
function $046413053845cee4$export$67ebef60e6f28a6(thisArg, body) {
    var _ = {
        label: 0,
        sent: function() {
            if (t[0] & 1) throw t[1];
...
function $046413053845cee4$export$45d3717a4c69092e(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    o[k2] = m[k];
}
function $046413053845cee4$export$f33643c0debef087(m, exports) {
    for(var p in m)if (p !== "default" && !exports.hasOwnProperty(p)) exports[p] = m[p];
}
function $046413053845cee4$export$19a8beecd37a4c45(o) {
...
function $046413053845cee4$export$8d051b38c9118094(o, n) {
...
function $046413053845cee4$export$afc72e2116322959() {
    for(var ar = [], i = 0; i < arguments.length; i++)ar = ar.concat($046413053845cee4$export$8d051b38c9118094(arguments[i]));
    return ar;
}
function $046413053845cee4$export$6388937ca91ccae8() {
    for(var s = 0, i = 0, il = arguments.length; i < il; i++)s += arguments[i].length;
    for(var r = Array(s), k = 0, i = 0; i < il; i++)for(var a = arguments[i], j = 0, jl = a.length; j < jl; j++, k++)r[k] = a[j];
    return r;
}
function $046413053845cee4$export$10c90e4f7922046c(v) {
    return this instanceof $046413053845cee4$export$10c90e4f7922046c ? (this.v = v, this) : new $046413053845cee4$export$10c90e4f7922046c(v);
}
function $046413053845cee4$export$e427f37a30a4de9b(thisArg, _arguments, generator) {
    ...
    function step(r) {
        r.value instanceof $046413053845cee4$export$10c90e4f7922046c ? Promise.resolve(r.value.v).then(fulfill, reject) : settle(q[0][2], r);
    }
...
function $046413053845cee4$export$bbd80228419bb833(o) {
    var i, p;
    ...
    function verb(n, f) {
        i[n] = o[n] ? function(v) {
            return (p = !p) ? {
                value: $046413053845cee4$export$10c90e4f7922046c(o[n](v)),
                done: n === "return"
            } : f ? f(v) : v;
        } : f;
    }
}
function $046413053845cee4$export$e3b29a3d6162315f(o) {
    if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
    var m = o[Symbol.asyncIterator], i;
    return m ? m.call(o) : (o = typeof $046413053845cee4$export$19a8beecd37a4c45 === "function" ? $046413053845cee4$export$19a8beecd37a4c45(o) : o[Symbol.iterator](), i = {}, verb("next"), verb("throw"), verb("return"), i[Symbol.asyncIterator] = function() {
        return this;
    }, i);
    function verb(n) {
        i[n] = o[n] && function(v) {
...
function $046413053845cee4$export$4fb47efe1390b86f(cooked, raw) {
...
function $046413053845cee4$export$c21735bcef00d192(mod) {
...
function $046413053845cee4$export$da59b14a69baef04(mod) {
    return mod && mod.__esModule ? mod : {
        default: mod
    };
}
function $046413053845cee4$export$d5dcaf168c640c35(receiver, privateMap) {
    if (!privateMap.has(receiver)) throw new TypeError("attempted to get private field on non-instance");
    return privateMap.get(receiver);
}
function $046413053845cee4$export$d40a35129aaff81f(receiver, privateMap, value) {
...
parcelRequire.register("6LaRI", function(module, exports) {

});

parcelRequire.register("axPtg", function(module, exports) {

$parcel$export(module.exports, "scrollbarMap", function () { return $7ad4e9817d549c58$export$18a24ca5e48929da; });
$parcel$export(module.exports, "Scrollbar", function () { return $7ad4e9817d549c58$export$9a4e88b92edfce6b; });

var $nn6O4 = parcelRequire("nn6O4");

var $bg6Uf = parcelRequire("bg6Uf");

var $iRxPm = parcelRequire("iRxPm");
parcelRequire("ihaPO");
var $2Y5zv = parcelRequire("2Y5zv");
var $6Rgzf = parcelRequire("6Rgzf");
parcelRequire("8W7wk");
var $fz8J7 = parcelRequire("fz8J7");

var $cHGIq = parcelRequire("cHGIq");
parcelRequire("eSpu0");
var $2McEp = parcelRequire("2McEp");
var $80tqQ = parcelRequire("80tqQ");
var $2u9rS = parcelRequire("2u9rS");
parcelRequire("2HYZy");
var $bj4Rg = parcelRequire("bj4Rg");
var $dGXlp = parcelRequire("dGXlp");
var $1XFJR = parcelRequire("1XFJR");

var $9SjjN = parcelRequire("9SjjN");

var $dNhCl = parcelRequire("dNhCl");
var $7ad4e9817d549c58$export$18a24ca5e48929da = new Map();
var $7ad4e9817d549c58$export$9a4e88b92edfce6b = /** @class */ function() {
    function Scrollbar(containerEl, options) {
        ...
        this.options = new (0, $iRxPm.Options)(options);
        // mark as a scroll element
        containerEl.setAttribute("data-scrollbar", "true");
        // make container focusable
        containerEl.setAttribute("tabindex", "-1");
        (0, $2Y5zv.setStyle)(containerEl, {
            overflow: "hidden",
            outline: "none"
        });
        ...
        // attach track
        this.track = new (0, $cHGIq.TrackController)(this);
        // initial measuring
        this.size = this.getSize();
        // init plugins
        this._plugins = (0, $9SjjN.initPlugins)(this, this.options.plugins);
        ...
        $7ad4e9817d549c58$export$18a24ca5e48929da.set(containerEl, this);
        // wait for DOM ready
        requestAnimationFrame(function() {
            _this._init();
        });
    ...
    Object.defineProperty(Scrollbar.prototype, "parent", {
         ...
         */ get: function() {
            ...
            while(elem){
                var parentScrollbar = $7ad4e9817d549c58$export$18a24ca5e48929da.get(elem);
     ...
     */ Scrollbar.prototype.isVisible = function(elem) {
        return (0, $2u9rS.isVisible)(this, elem);
    };
    /**
     ...
     */ Scrollbar.prototype.setPosition = function(x, y, options) {
        ...
        var status = (0, $bj4Rg.setPosition)(this, x, y);
     ...
     */ Scrollbar.prototype.scrollTo = function(x, y, duration, options) {
        ...
        if (options === void 0) options = {};
        (0, $dGXlp.scrollTo)(this, x, y, duration, options);
    };
    /**
     ...
     */ Scrollbar.prototype.scrollIntoView = function(elem, options) {
        if (options === void 0) options = {};
        (0, $1XFJR.scrollIntoView)(this, elem, options);
    };
    /**
    ...
    Scrollbar.prototype.destroy = function() {
        ...
        (0, $6Rgzf.clearEventsOn)(this);
        this._listeners.clear();
        this.setMomentum(0, 0);
        cancelAnimationFrame(this._renderID);
        if (this._observer) this._observer.disconnect();
        $7ad4e9817d549c58$export$18a24ca5e48929da.delete(this.containerEl);
        // restore contents
    ...
    Scrollbar.prototype._init = function() {
        ...
        this.update();
        // init evet handlers
        Object.keys($dNhCl).forEach(function(prop) {
            $dNhCl[prop](_this);
        });
    ...
    Scrollbar.prototype._shouldPropagateMomentum = function(deltaX, deltaY) {
        ...
        var destX = (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(deltaX + offset.x, 0, limit.x);
        var destY = (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(deltaY + offset.y, 0, limit.y);
        var res = true;
    ...
    Scrollbar.prototype._render = function() {
        ...
        var remain = (0, $nn6O4.__assign)({}, this._momentum);
        this._plugins.forEach(function(plugin) {
...
parcelRequire.register("bg6Uf", function(module, exports) {
/**
 ...
 */ /** Used as references for various `Number` constants. */ var $83268bc9d36b9367$var$NAN = 0 / 0;
/** `Object#toString` result references. */ var $83268bc9d36b9367$var$symbolTag = "[object Symbol]";
/** Used to match leading and trailing whitespace. */ var $83268bc9d36b9367$var$reTrim = /^\s+|\s+$/g;
/** Used to detect bad signed hexadecimal string values. */ var $83268bc9d36b9367$var$reIsBadHex = /^[-+]0x[0-9a-f]+$/i;
/** Used to detect binary string values. */ var $83268bc9d36b9367$var$reIsBinary = /^0b[01]+$/i;
/** Used to detect octal string values. */ var $83268bc9d36b9367$var$reIsOctal = /^0o[0-7]+$/i;
/** Built-in method references without a dependency on `root`. */ var $83268bc9d36b9367$var$freeParseInt = parseInt;
/** Used for built-in method references. */ var $83268bc9d36b9367$var$objectProto = Object.prototype;
/**
 * Used to resolve the
 * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
 * of values.
 */ var $83268bc9d36b9367$var$objectToString = $83268bc9d36b9367$var$objectProto.toString;
/**
 ...
 */ function $83268bc9d36b9367$var$baseClamp(number, lower, upper) {
    if (number === number) {
 ...
 * _.isObject(null);
 * // => false
 */ function $83268bc9d36b9367$var$isObject(value) {
 ...
 * _.isObjectLike(null);
 * // => false
 */ function $83268bc9d36b9367$var$isObjectLike(value) {
 ...
 * _.isSymbol('abc');
 * // => false
 */ function $83268bc9d36b9367$var$isSymbol(value) {
    return typeof value == "symbol" || $83268bc9d36b9367$var$isObjectLike(value) && $83268bc9d36b9367$var$objectToString.call(value) == $83268bc9d36b9367$var$symbolTag;
}
/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */ function $83268bc9d36b9367$var$toNumber(value) {
    if (typeof value == "number") return value;
    if ($83268bc9d36b9367$var$isSymbol(value)) return $83268bc9d36b9367$var$NAN;
    if ($83268bc9d36b9367$var$isObject(value)) {
        var other = typeof value.valueOf == "function" ? value.valueOf() : value;
        value = $83268bc9d36b9367$var$isObject(other) ? other + "" : other;
    }
    if (typeof value != "string") return value === 0 ? value : +value;
    value = value.replace($83268bc9d36b9367$var$reTrim, "");
    var isBinary = $83268bc9d36b9367$var$reIsBinary.test(value);
    return isBinary || $83268bc9d36b9367$var$reIsOctal.test(value) ? $83268bc9d36b9367$var$freeParseInt(value.slice(2), isBinary ? 2 : 8) : $83268bc9d36b9367$var$reIsBadHex.test(value) ? $83268bc9d36b9367$var$NAN : +value;
}
/**
 ...
 * _.clamp(10, -5, 5);
 * // => 5
 */ function $83268bc9d36b9367$var$clamp(number, lower, upper) {
    if (upper === undefined) {
        upper = lower;
        lower = undefined;
    }
    if (upper !== undefined) {
        upper = $83268bc9d36b9367$var$toNumber(upper);
        upper = upper === upper ? upper : 0;
    }
    if (lower !== undefined) {
        lower = $83268bc9d36b9367$var$toNumber(lower);
        lower = lower === lower ? lower : 0;
    }
    return $83268bc9d36b9367$var$baseClamp($83268bc9d36b9367$var$toNumber(number), lower, upper);
}
module.exports = $83268bc9d36b9367$var$clamp;

});

parcelRequire.register("iRxPm", function(module, exports) {

$parcel$export(module.exports, "Options", function () { return $dbb76aa23a88fadd$export$c019608e5b5bb4cb; });

var $nn6O4 = parcelRequire("nn6O4");
parcelRequire("8W7wk");
var $7Npa5 = parcelRequire("7Npa5");
var $lFLMO = parcelRequire("lFLMO");
var $dbb76aa23a88fadd$export$c019608e5b5bb4cb = /** @class */ function() {
...
parcelRequire.register("8W7wk", function(module, exports) {
$parcel$export(module.exports, "range", function () { return (parcelRequire("7Npa5")).range; });
$parcel$export(module.exports, "boolean", function () { return (parcelRequire("lFLMO")).boolean; });
$parcel$export(module.exports, "debounce", function () { return (parcelRequire("fz8J7")).debounce; });
parcelRequire("7Npa5");
parcelRequire("lFLMO");
parcelRequire("fz8J7");

});
parcelRequire.register("7Npa5", function(module, exports) {

$parcel$export(module.exports, "range", function () { return $5ad0a09438bc05c9$export$d02631cccf789723; });

var $bg6Uf = parcelRequire("bg6Uf");
function $5ad0a09438bc05c9$export$d02631cccf789723(min, max) {
        ...
        Object.defineProperty(proto, key, {
            ...
            set: function(val) {
                Object.defineProperty(this, alias, {
                    value: (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(val, min, max),
                    enumerable: false,
                    writable: true,
                    configurable: true
                });
...
parcelRequire.register("lFLMO", function(module, exports) {

$parcel$export(module.exports, "boolean", function () { return $fc727eadef529ba0$export$4a21f16c33752377; });
function $fc727eadef529ba0$export$4a21f16c33752377(proto, key) {
    var alias = "_" + key;
    Object.defineProperty(proto, key, {
        get: function() {
            return this[alias];
...
parcelRequire.register("fz8J7", function(module, exports) {

$parcel$export(module.exports, "debounce", function () { return $b550e4d22dc4eeca$export$61fc7d43ac8f84b0; });

var $nn6O4 = parcelRequire("nn6O4");

var $coBa3 = parcelRequire("coBa3");
function $b550e4d22dc4eeca$export$61fc7d43ac8f84b0() {
    var options = [];
        ...
        return {
            get: function() {
                if (!this.hasOwnProperty(key)) Object.defineProperty(this, key, {
                    value: (0, (/*@__PURE__*/$parcel$interopDefault($coBa3))).apply(void 0, (0, $nn6O4.__spreadArrays)([
                        fn
                    ], options))
                });
                return this[key];
...
parcelRequire.register("coBa3", function(module, exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
 ...
 * Based on Underscore.js 1.8.3 <http://underscorejs.org/LICENSE>
 * Copyright Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
 */ /** Used as the `TypeError` message for "Functions" methods. */ var $90648d59e75d13c1$var$FUNC_ERROR_TEXT = "Expected a function";
/** Used as references for various `Number` constants. */ var $90648d59e75d13c1$var$NAN = 0 / 0;
/** `Object#toString` result references. */ var $90648d59e75d13c1$var$symbolTag = "[object Symbol]";
/** Used to match leading and trailing whitespace. */ var $90648d59e75d13c1$var$reTrim = /^\s+|\s+$/g;
/** Used to detect bad signed hexadecimal string values. */ var $90648d59e75d13c1$var$reIsBadHex = /^[-+]0x[0-9a-f]+$/i;
/** Used to detect binary string values. */ var $90648d59e75d13c1$var$reIsBinary = /^0b[01]+$/i;
/** Used to detect octal string values. */ var $90648d59e75d13c1$var$reIsOctal = /^0o[0-7]+$/i;
/** Built-in method references without a dependency on `root`. */ var $90648d59e75d13c1$var$freeParseInt = parseInt;
/** Detect free variable `global` from Node.js. */ var $90648d59e75d13c1$var$freeGlobal = typeof $parcel$global == "object" && $parcel$global && $parcel$global.Object === Object && $parcel$global;
/** Detect free variable `self`. */ var $90648d59e75d13c1$var$freeSelf = typeof self == "object" && self && self.Object === Object && self;
/** Used as a reference to the global object. */ var $90648d59e75d13c1$var$root = $90648d59e75d13c1$var$freeGlobal || $90648d59e75d13c1$var$freeSelf || Function("return this")();
/** Used for built-in method references. */ var $90648d59e75d13c1$var$objectProto = Object.prototype;
/**
 * Used to resolve the
 * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
 * of values.
 */ var $90648d59e75d13c1$var$objectToString = $90648d59e75d13c1$var$objectProto.toString;
/* Built-in method references for those with the same name as other `lodash` methods. */ var $90648d59e75d13c1$var$nativeMax = Math.max, $90648d59e75d13c1$var$nativeMin = Math.min;
/**
 ...
 */ var $90648d59e75d13c1$var$now = function() {
    return $90648d59e75d13c1$var$root.Date.now();
};
/**
 ...
 */ function $90648d59e75d13c1$var$debounce(func, wait, options) {
    var lastArgs, lastThis, maxWait, result, timerId, lastCallTime, lastInvokeTime = 0, leading = false, maxing = false, trailing = true;
    if (typeof func != "function") throw new TypeError($90648d59e75d13c1$var$FUNC_ERROR_TEXT);
    wait = $90648d59e75d13c1$var$toNumber(wait) || 0;
    if ($90648d59e75d13c1$var$isObject(options)) {
        leading = !!options.leading;
        maxing = "maxWait" in options;
        maxWait = maxing ? $90648d59e75d13c1$var$nativeMax($90648d59e75d13c1$var$toNumber(options.maxWait) || 0, wait) : maxWait;
    ...
    function remainingWait(time) {
        ...
        return maxing ? $90648d59e75d13c1$var$nativeMin(result, maxWait - timeSinceLastInvoke) : result;
    }
    ...
    function timerExpired() {
        var time = $90648d59e75d13c1$var$now();
    ...
    function flush() {
        return timerId === undefined ? result : trailingEdge($90648d59e75d13c1$var$now());
    }
    function debounced() {
        var time = $90648d59e75d13c1$var$now(), isInvoking = shouldInvoke(time);
        lastArgs = arguments;
        lastThis = this;
        lastCallTime = time;
        if (isInvoking) {
 ...
 * _.isObject(null);
 * // => false
 */ function $90648d59e75d13c1$var$isObject(value) {
    var type = typeof value;
    return !!value && (type == "object" || type == "function");
}
/**
 ...
 * _.isObjectLike(null);
 * // => false
 */ function $90648d59e75d13c1$var$isObjectLike(value) {
    return !!value && typeof value == "object";
}
/**
 * Checks if `value` is classified as a `Symbol` primitive or object.
 ...
 * _.isSymbol('abc');
 * // => false
 */ function $90648d59e75d13c1$var$isSymbol(value) {
    return typeof value == "symbol" || $90648d59e75d13c1$var$isObjectLike(value) && $90648d59e75d13c1$var$objectToString.call(value) == $90648d59e75d13c1$var$symbolTag;
}
/**
 * Converts `value` to a number.
 *
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */ function $90648d59e75d13c1$var$toNumber(value) {
    if (typeof value == "number") return value;
    if ($90648d59e75d13c1$var$isSymbol(value)) return $90648d59e75d13c1$var$NAN;
    if ($90648d59e75d13c1$var$isObject(value)) {
        var other = typeof value.valueOf == "function" ? value.valueOf() : value;
        value = $90648d59e75d13c1$var$isObject(other) ? other + "" : other;
    }
    if (typeof value != "string") return value === 0 ? value : +value;
    value = value.replace($90648d59e75d13c1$var$reTrim, "");
    var isBinary = $90648d59e75d13c1$var$reIsBinary.test(value);
    return isBinary || $90648d59e75d13c1$var$reIsOctal.test(value) ? $90648d59e75d13c1$var$freeParseInt(value.slice(2), isBinary ? 2 : 8) : $90648d59e75d13c1$var$reIsBadHex.test(value) ? $90648d59e75d13c1$var$NAN : +value;
}
module.exports = $90648d59e75d13c1$var$debounce;
...
parcelRequire.register("ihaPO", function(module, exports) {
$parcel$export(module.exports, "clearEventsOn", function () { return (parcelRequire("6Rgzf")).clearEventsOn; });
$parcel$export(module.exports, "eventScope", function () { return (parcelRequire("6Rgzf")).eventScope; });
$parcel$export(module.exports, "getPosition", function () { return (parcelRequire("klreC")).getPosition; });
$parcel$export(module.exports, "isOneOf", function () { return (parcelRequire("ezxo4")).isOneOf; });
$parcel$export(module.exports, "setStyle", function () { return (parcelRequire("2Y5zv")).setStyle; });
$parcel$export(module.exports, "TouchRecord", function () { return (parcelRequire("kgU8P")).TouchRecord; });
parcelRequire("6Rgzf");
parcelRequire("iMwLK");
parcelRequire("klreC");
parcelRequire("ezxo4");
...
parcelRequire.register("6Rgzf", function(module, exports) {

$parcel$export(module.exports, "eventScope", function () { return $4fe48b43f824f69d$export$cfedec40817575fe; });
$parcel$export(module.exports, "clearEventsOn", function () { return $4fe48b43f824f69d$export$2bf7a27f443e4893; });
var $4fe48b43f824f69d$var$eventListenerOptions;
var $4fe48b43f824f69d$var$eventMap = new WeakMap();
function $4fe48b43f824f69d$var$getOptions() {
    if ($4fe48b43f824f69d$var$eventListenerOptions !== undefined) return $4fe48b43f824f69d$var$eventListenerOptions;
    ...
    $4fe48b43f824f69d$var$eventListenerOptions = supportPassiveEvent ? {
        passive: false
    } : false;
    return $4fe48b43f824f69d$var$eventListenerOptions;
}
function $4fe48b43f824f69d$export$cfedec40817575fe(scrollbar) {
    var configs = $4fe48b43f824f69d$var$eventMap.get(scrollbar) || [];
    $4fe48b43f824f69d$var$eventMap.set(scrollbar, configs);
    return function addEvent(elem, events, fn) {
        ...
        events.split(/\s+/g).forEach(function(eventName) {
            ...
            elem.addEventListener(eventName, handler, $4fe48b43f824f69d$var$getOptions());
        });
    };
}
function $4fe48b43f824f69d$export$2bf7a27f443e4893(scrollbar) {
    var configs = $4fe48b43f824f69d$var$eventMap.get(scrollbar);
    if (!configs) return;
    configs.forEach(function(_a) {
        var elem = _a.elem, eventName = _a.eventName, handler = _a.handler;
        elem.removeEventListener(eventName, handler, $4fe48b43f824f69d$var$getOptions());
    });
    $4fe48b43f824f69d$var$eventMap.delete(scrollbar);
}

});

parcelRequire.register("iMwLK", function(module, exports) {

$parcel$export(module.exports, "getPointerData", function () { return $dac620f7b9319072$export$f7b14ec3e1349d05; });
/**
 * Get pointer/touch data
 */ function $dac620f7b9319072$export$f7b14ec3e1349d05(evt) {
...
parcelRequire.register("klreC", function(module, exports) {

$parcel$export(module.exports, "getPosition", function () { return $ecfae51514bb3f16$export$1690e12b840569b9; });

var $iMwLK = parcelRequire("iMwLK");
function $ecfae51514bb3f16$export$1690e12b840569b9(evt) {
    var data = (0, $iMwLK.getPointerData)(evt);
    return {
        x: data.clientX,
        y: data.clientY
    };
...
parcelRequire.register("ezxo4", function(module, exports) {

$parcel$export(module.exports, "isOneOf", function () { return $a9be3b9aa0bd9093$export$532a90c0e5e8e48c; });
/**
 * Check if `a` is one of `[...b]`
 */ function $a9be3b9aa0bd9093$export$532a90c0e5e8e48c(a, b) {
    if (b === void 0) b = [];
...
parcelRequire.register("2Y5zv", function(module, exports) {

$parcel$export(module.exports, "setStyle", function () { return $229581c35744dbe7$export$37a5fde709c1db82; });
var $229581c35744dbe7$var$VENDOR_PREFIX = [
    "webkit",
    "moz",
    "ms",
    "o"
];
var $229581c35744dbe7$var$RE = new RegExp("^-(?!(?:" + $229581c35744dbe7$var$VENDOR_PREFIX.join("|") + ")-)");
function $229581c35744dbe7$var$autoPrefix(styles) {
    var res = {};
    Object.keys(styles).forEach(function(prop) {
        if (!$229581c35744dbe7$var$RE.test(prop)) {
        ...
        prop = prop.replace(/^-/, "");
        res[prop] = val;
        $229581c35744dbe7$var$VENDOR_PREFIX.forEach(function(prefix) {
            res["-" + prefix + "-" + prop] = val;
        });
    });
    return res;
}
function $229581c35744dbe7$export$37a5fde709c1db82(elem, styles) {
    styles = $229581c35744dbe7$var$autoPrefix(styles);
    Object.keys(styles).forEach(function(prop) {
...
parcelRequire.register("kgU8P", function(module, exports) {

$parcel$export(module.exports, "TouchRecord", function () { return $ec20d9cc934756e4$export$9da4f16074124683; });

var $nn6O4 = parcelRequire("nn6O4");

var $klreC = parcelRequire("klreC");
var $ec20d9cc934756e4$export$254d9747e34ddc90 = /** @class */ function() {
    function Tracker(touch) {
        ...
        this.lastPosition = (0, $klreC.getPosition)(touch);
    }
    Tracker.prototype.update = function(touch) {
        var _a = this, velocity = _a.velocity, updateTime = _a.updateTime, lastPosition = _a.lastPosition;
        var now = Date.now();
        var position = (0, $klreC.getPosition)(touch);
        var delta = {
...
var $ec20d9cc934756e4$export$9da4f16074124683 = /** @class */ function() {
    ...
    TouchRecord.prototype.getDelta = function() {
        ...
        return (0, $nn6O4.__assign)({}, tracker.delta);
    };
    TouchRecord.prototype.getVelocity = function() {
        var tracker = this._getActiveTracker();
        if (!tracker) return this._primitiveValue;
        return (0, $nn6O4.__assign)({}, tracker.velocity);
    };
    ...
    TouchRecord.prototype._add = function(touch) {
        ...
        this._delete(touch);
        var tracker = new $ec20d9cc934756e4$export$254d9747e34ddc90(touch);
...
parcelRequire.register("cHGIq", function(module, exports) {

$parcel$export(module.exports, "TrackController", function () { return $93faa297ac68bfc1$export$40a0242a5dec07f5; });

var $nn6O4 = parcelRequire("nn6O4");

var $POOAA = parcelRequire("POOAA");

var $ONKV1 = parcelRequire("ONKV1");
parcelRequire("8W7wk");
var $fz8J7 = parcelRequire("fz8J7");
var $93faa297ac68bfc1$export$40a0242a5dec07f5 = /** @class */ function() {
    function TrackController(_scrollbar) {
        this._scrollbar = _scrollbar;
        var thumbMinSize = _scrollbar.options.thumbMinSize;
        this.xAxis = new (0, $POOAA.ScrollbarTrack)((0, $ONKV1.TrackDirection).X, thumbMinSize);
        this.yAxis = new (0, $POOAA.ScrollbarTrack)((0, $ONKV1.TrackDirection).Y, thumbMinSize);
    ...
    (0, $nn6O4.__decorate)([
        (0, $fz8J7.debounce)(300)
    ], TrackController.prototype, "autoHideOnIdle", null);
    return TrackController;
}();

});
parcelRequire.register("POOAA", function(module, exports) {

$parcel$export(module.exports, "ScrollbarTrack", function () { return $09bc2e53801dd844$export$9e82a9d3e0d2088; });

var $2Uq53 = parcelRequire("2Uq53");
parcelRequire("ihaPO");
var $2Y5zv = parcelRequire("2Y5zv");
var $09bc2e53801dd844$export$9e82a9d3e0d2088 = /** @class */ function() {
    function ScrollbarTrack(direction, thumbMinSize) {
        ...
        this.thumb = new (0, $2Uq53.ScrollbarThumb)(direction, thumbMinSize);
...
parcelRequire.register("2Uq53", function(module, exports) {

$parcel$export(module.exports, "ScrollbarThumb", function () { return $21e50aca93cc1392$export$2d610e681b8dabf8; });

var $ONKV1 = parcelRequire("ONKV1");
parcelRequire("ihaPO");
var $2Y5zv = parcelRequire("2Y5zv");
var $21e50aca93cc1392$export$2d610e681b8dabf8 = /** @class */ function() {
    ...
    ScrollbarThumb.prototype.update = function(scrollOffset, containerSize, pageSize) {
        ...
        (0, $2Y5zv.setStyle)(this.element, this._getStyle());
    };
    ScrollbarThumb.prototype._getStyle = function() {
        switch(this._direction){
            case (0, $ONKV1.TrackDirection).X:
                return {
                    width: this.displaySize + "px",
                    "-transform": "translate3d(" + this.offset + "px, 0, 0)"
                };
            case (0, $ONKV1.TrackDirection).Y:
                return {
...
parcelRequire.register("ONKV1", function(module, exports) {

$parcel$export(module.exports, "TrackDirection", function () { return $098b4415369c9a7d$export$2d4c17c1fb94ad57; });
var $098b4415369c9a7d$export$2d4c17c1fb94ad57;
(function(TrackDirection) {
    TrackDirection["X"] = "x";
    TrackDirection["Y"] = "y";
})($098b4415369c9a7d$export$2d4c17c1fb94ad57 || ($098b4415369c9a7d$export$2d4c17c1fb94ad57 = {}));
...
parcelRequire.register("eSpu0", function(module, exports) {
$parcel$export(module.exports, "getSize", function () { return (parcelRequire("2McEp")).getSize; });
$parcel$export(module.exports, "isVisible", function () { return (parcelRequire("2u9rS")).isVisible; });
$parcel$export(module.exports, "update", function () { return (parcelRequire("80tqQ")).update; });
parcelRequire("2McEp");
parcelRequire("2u9rS");
parcelRequire("80tqQ");

});
parcelRequire.register("2McEp", function(module, exports) {

$parcel$export(module.exports, "getSize", function () { return $2059e09ea3b1ad82$export$31b21d0167753bb4; });
function $2059e09ea3b1ad82$export$31b21d0167753bb4(scrollbar) {
...
parcelRequire.register("2u9rS", function(module, exports) {

$parcel$export(module.exports, "isVisible", function () { return $1cf5b666f9429a9e$export$795910f5f15a9633; });
function $1cf5b666f9429a9e$export$795910f5f15a9633(scrollbar, elem) {
...
parcelRequire.register("80tqQ", function(module, exports) {

$parcel$export(module.exports, "update", function () { return $5d45276ba1f82474$export$722fbec263ad908a; });
function $5d45276ba1f82474$export$722fbec263ad908a(scrollbar) {
...
parcelRequire.register("2HYZy", function(module, exports) {
$parcel$export(module.exports, "setPosition", function () { return (parcelRequire("bj4Rg")).setPosition; });
$parcel$export(module.exports, "scrollTo", function () { return (parcelRequire("dGXlp")).scrollTo; });
$parcel$export(module.exports, "scrollIntoView", function () { return (parcelRequire("1XFJR")).scrollIntoView; });
parcelRequire("bj4Rg");
parcelRequire("dGXlp");
parcelRequire("1XFJR");

});
parcelRequire.register("bj4Rg", function(module, exports) {

$parcel$export(module.exports, "setPosition", function () { return $83b53cc0f8acd669$export$f9b088a47202d605; });
...
parcelRequire("ihaPO");
var $2Y5zv = parcelRequire("2Y5zv");
function $83b53cc0f8acd669$export$f9b088a47202d605(scrollbar, x, y) {
    var options = scrollbar.options, offset = scrollbar.offset, limit = scrollbar.limit, track = scrollbar.track, contentEl = scrollbar.contentEl;
    if (options.renderByPixels) {
        x = Math.round(x);
        y = Math.round(y);
    }
    x = (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(x, 0, limit.x);
    y = (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(y, 0, limit.y);
    ...
    offset.x = x;
    offset.y = y;
    (0, $2Y5zv.setStyle)(contentEl, {
        "-transform": "translate3d(" + -x + "px, " + -y + "px, 0)"
    });
    track.update();
    return {
        offset: (0, $nn6O4.__assign)({}, offset),
        limit: (0, $nn6O4.__assign)({}, limit)
    };
}

});

parcelRequire.register("dGXlp", function(module, exports) {

$parcel$export(module.exports, "scrollTo", function () { return $02928936611a48b7$export$3f99968195accfaf; });

var $bg6Uf = parcelRequire("bg6Uf");
var $02928936611a48b7$var$animationIDStorage = new WeakMap();
function $02928936611a48b7$export$3f99968195accfaf(scrollbar, x, y, duration, _a) {
    if (duration === void 0) duration = 0;
    var _b = _a === void 0 ? {} : _a, _c = _b.easing, easing = _c === void 0 ? $02928936611a48b7$var$defaultEasing : _c, callback = _b.callback;
    ...
    var startX = offset.x;
    var startY = offset.y;
    var disX = (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(x, 0, limit.x) - startX;
    var disY = (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(y, 0, limit.y) - startY;
    var start = Date.now();
    function scroll() {
        ...
        if (elapse >= duration) {
            ...
            $02928936611a48b7$var$animationIDStorage.set(scrollbar, animationID);
        }
    }
    cancelAnimationFrame($02928936611a48b7$var$animationIDStorage.get(scrollbar));
    scroll();
}
/**
 * easeOutCubic
 */ function $02928936611a48b7$var$defaultEasing(t) {
    return Math.pow(t - 1, 3) + 1;
}

});

parcelRequire.register("1XFJR", function(module, exports) {

$parcel$export(module.exports, "scrollIntoView", function () { return $16dbad8ddf83bfb4$export$53a0910f038337bd; });

var $bg6Uf = parcelRequire("bg6Uf");
function $16dbad8ddf83bfb4$export$53a0910f038337bd(scrollbar, elem, _a) {
    ...
    scrollbar.setMomentum(targetBounding.left - bounding.left - offsetLeft, (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(delta, -offset.y, limit.y - offset.y));
}

});


parcelRequire.register("9SjjN", function(module, exports) {

$parcel$export(module.exports, "ScrollbarPlugin", function () { return $7308246e7eb9b92f$export$db53f857c251fca3; });
$parcel$export(module.exports, "addPlugins", function () { return $7308246e7eb9b92f$export$19ec5365ea6ce8cf; });
$parcel$export(module.exports, "initPlugins", function () { return $7308246e7eb9b92f$export$d117388934d9aaf6; });

var $nn6O4 = parcelRequire("nn6O4");
var $7308246e7eb9b92f$export$db53f857c251fca3 = /** @class */ function() {
    function ScrollbarPlugin(scrollbar, options) {
        var _newTarget = this.constructor;
        this.scrollbar = scrollbar;
        this.name = _newTarget.pluginName;
        this.options = (0, $nn6O4.__assign)((0, $nn6O4.__assign)({}, _newTarget.defaultOptions), options);
    }
    ...
    ScrollbarPlugin.prototype.transformDelta = function(delta, _evt) {
        return (0, $nn6O4.__assign)({}, delta);
    };
    ScrollbarPlugin.pluginName = "";
    ScrollbarPlugin.defaultOptions = {};
    return ScrollbarPlugin;
}();
var $7308246e7eb9b92f$export$905153d94e0757fa = {
    order: new Set(),
    constructors: {}
};
function $7308246e7eb9b92f$export$19ec5365ea6ce8cf() {
    var Plugins = [];
    for(var _i = 0; _i < arguments.length; _i++)Plugins[_i] = arguments[_i];
    Plugins.forEach(function(P) {
        var pluginName = P.pluginName;
        if (!pluginName) throw new TypeError("plugin name is required");
        $7308246e7eb9b92f$export$905153d94e0757fa.order.add(pluginName);
        $7308246e7eb9b92f$export$905153d94e0757fa.constructors[pluginName] = P;
    });
}
function $7308246e7eb9b92f$export$d117388934d9aaf6(scrollbar, options) {
    return Array.from($7308246e7eb9b92f$export$905153d94e0757fa.order).filter(function(pluginName) {
        return options[pluginName] !== false;
    }).map(function(pluginName) {
        var Plugin = $7308246e7eb9b92f$export$905153d94e0757fa.constructors[pluginName];
...
parcelRequire.register("dNhCl", function(module, exports) {

var $a9zRx = parcelRequire("a9zRx");

var $8UjTK = parcelRequire("8UjTK");

var $6sAs4 = parcelRequire("6sAs4");

var $6UNyT = parcelRequire("6UNyT");

var $c9N4F = parcelRequire("c9N4F");

var $jpfs0 = parcelRequire("jpfs0");
$parcel$exportWildcard(module.exports, $a9zRx);
$parcel$exportWildcard(module.exports, $8UjTK);
$parcel$exportWildcard(module.exports, $6sAs4);
$parcel$exportWildcard(module.exports, $6UNyT);
$parcel$exportWildcard(module.exports, $c9N4F);
$parcel$exportWildcard(module.exports, $jpfs0);

});
parcelRequire.register("a9zRx", function(module, exports) {

$parcel$export(module.exports, "keyboardHandler", function () { return $7646902bae1ddb76$export$6ff2ab7955f7f068; });
parcelRequire("ihaPO");
var $6Rgzf = parcelRequire("6Rgzf");
var $7646902bae1ddb76$var$KEY_CODE;
(function(KEY_CODE) {
...
})($7646902bae1ddb76$var$KEY_CODE || ($7646902bae1ddb76$var$KEY_CODE = {}));
function $7646902bae1ddb76$export$6ff2ab7955f7f068(scrollbar) {
    var addEvent = (0, $6Rgzf.eventScope)(scrollbar);
    var container = scrollbar.containerEl;
    addEvent(container, "keydown", function(evt) {
        var activeElement = document.activeElement;
        if (activeElement !== container && !container.contains(activeElement)) return;
        if ($7646902bae1ddb76$var$isEditable(activeElement)) return;
        var delta = $7646902bae1ddb76$var$getKeyDelta(scrollbar, evt.keyCode || evt.which);
        if (!delta) return;
...
function $7646902bae1ddb76$var$getKeyDelta(scrollbar, keyCode) {
    var size = scrollbar.size, limit = scrollbar.limit, offset = scrollbar.offset;
    switch(keyCode){
        case $7646902bae1ddb76$var$KEY_CODE.TAB:
            return $7646902bae1ddb76$var$handleTabKey(scrollbar);
        case $7646902bae1ddb76$var$KEY_CODE.SPACE:
            return [
                0,
                200
            ];
        case $7646902bae1ddb76$var$KEY_CODE.PAGE_UP:
            return [
                0,
                -size.container.height + 40
            ];
        case $7646902bae1ddb76$var$KEY_CODE.PAGE_DOWN:
            return [
                0,
                size.container.height - 40
            ];
        case $7646902bae1ddb76$var$KEY_CODE.END:
            return [
                0,
                limit.y - offset.y
            ];
        case $7646902bae1ddb76$var$KEY_CODE.HOME:
            return [
                0,
                -offset.y
            ];
        case $7646902bae1ddb76$var$KEY_CODE.LEFT:
            return [
                -40,
                0
            ];
        case $7646902bae1ddb76$var$KEY_CODE.UP:
            return [
                0,
                -40
            ];
        case $7646902bae1ddb76$var$KEY_CODE.RIGHT:
            return [
                40,
                0
            ];
        case $7646902bae1ddb76$var$KEY_CODE.DOWN:
            return [
                0,
                40
            ];
...
function $7646902bae1ddb76$var$handleTabKey(scrollbar) {
...
function $7646902bae1ddb76$var$isEditable(elem) {
...
parcelRequire.register("8UjTK", function(module, exports) {

$parcel$export(module.exports, "mouseHandler", function () { return $67c2fd0fe28e91d9$export$242d43875ab79ce3; });

var $bg6Uf = parcelRequire("bg6Uf");
parcelRequire("ihaPO");
var $6Rgzf = parcelRequire("6Rgzf");
var $ezxo4 = parcelRequire("ezxo4");
var $klreC = parcelRequire("klreC");
var $2Y5zv = parcelRequire("2Y5zv");
var $67c2fd0fe28e91d9$var$Direction;
(function(Direction) {
    Direction[Direction["X"] = 0] = "X";
    Direction[Direction["Y"] = 1] = "Y";
})($67c2fd0fe28e91d9$var$Direction || ($67c2fd0fe28e91d9$var$Direction = {}));
function $67c2fd0fe28e91d9$export$242d43875ab79ce3(scrollbar) {
    var addEvent = (0, $6Rgzf.eventScope)(scrollbar);
    var container = scrollbar.containerEl;
    var _a = scrollbar.track, xAxis = _a.xAxis, yAxis = _a.yAxis;
    function calcMomentum(direction, clickPosition) {
        var size = scrollbar.size, limit = scrollbar.limit, offset = scrollbar.offset;
        if (direction === $67c2fd0fe28e91d9$var$Direction.X) {
            var totalWidth = size.container.width + (xAxis.thumb.realSize - xAxis.thumb.displaySize);
            return (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(clickPosition / totalWidth * size.content.width, 0, limit.x) - offset.x;
        }
        if (direction === $67c2fd0fe28e91d9$var$Direction.Y) {
            var totalHeight = size.container.height + (yAxis.thumb.realSize - yAxis.thumb.displaySize);
            return (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(clickPosition / totalHeight * size.content.height, 0, limit.y) - offset.y;
        }
        return 0;
    }
    function getTrackDirection(elem) {
        if ((0, $ezxo4.isOneOf)(elem, [
            xAxis.element,
            xAxis.thumb.element
        ])) return $67c2fd0fe28e91d9$var$Direction.X;
        if ((0, $ezxo4.isOneOf)(elem, [
            yAxis.element,
            yAxis.thumb.element
        ])) return $67c2fd0fe28e91d9$var$Direction.Y;
        return void 0;
    }
    var isMouseDown;
    var isMouseMoving;
    ...
    addEvent(container, "click", function(evt) {
        if (isMouseMoving || !(0, $ezxo4.isOneOf)(evt.target, [
            xAxis.element,
            yAxis.element
        ])) return;
        ...
        var clickPos = (0, $klreC.getPosition)(evt);
        if (direction === $67c2fd0fe28e91d9$var$Direction.X) {
    ...
    addEvent(container, "mousedown", function(evt) {
        if (!(0, $ezxo4.isOneOf)(evt.target, [
            xAxis.thumb.element,
            yAxis.thumb.element
        ])) return;
        isMouseDown = true;
        var thumb = evt.target;
        var cursorPos = (0, $klreC.getPosition)(evt);
        ...
        (0, $2Y5zv.setStyle)(scrollbar.containerEl, {
            "-user-select": "none"
        });
    });
    addEvent(window, "mousemove", function(evt) {
        ...
        isMouseMoving = true;
        var cursorPos = (0, $klreC.getPosition)(evt);
        if (trackDirection === $67c2fd0fe28e91d9$var$Direction.X) {
        ...
        if (trackDirection === $67c2fd0fe28e91d9$var$Direction.Y) {
...
parcelRequire.register("6sAs4", function(module, exports) {

$parcel$export(module.exports, "resizeHandler", function () { return $4b41a22359c229fb$export$53d88fe222065052; });

var $coBa3 = parcelRequire("coBa3");
parcelRequire("ihaPO");
var $6Rgzf = parcelRequire("6Rgzf");
function $4b41a22359c229fb$export$53d88fe222065052(scrollbar) {
    var addEvent = (0, $6Rgzf.eventScope)(scrollbar);
    addEvent(window, "resize", (0, (/*@__PURE__*/$parcel$interopDefault($coBa3)))(scrollbar.update.bind(scrollbar), 300));
}

});

parcelRequire.register("6UNyT", function(module, exports) {

$parcel$export(module.exports, "selectHandler", function () { return $508e6af5e085b040$export$77907cd5c206b555; });

var $bg6Uf = parcelRequire("bg6Uf");
parcelRequire("ihaPO");
var $6Rgzf = parcelRequire("6Rgzf");
var $klreC = parcelRequire("klreC");
function $508e6af5e085b040$export$77907cd5c206b555(scrollbar) {
    var addEvent = (0, $6Rgzf.eventScope)(scrollbar);
    var containerEl = scrollbar.containerEl, contentEl = scrollbar.contentEl;
    ...
    function scroll(_a) {
        ...
        scrollbar.setMomentum((0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(offset.x + x, 0, limit.x) - offset.x, (0, (/*@__PURE__*/$parcel$interopDefault($bg6Uf)))(offset.y + y, 0, limit.y) - offset.y);
    ...
    addEvent(window, "mousemove", function(evt) {
        ...
        var dir = $508e6af5e085b040$var$calcMomentum(scrollbar, evt);
        scroll(dir);
    });
...
function $508e6af5e085b040$var$calcMomentum(scrollbar, evt) {
    var _a = scrollbar.bounding, top = _a.top, right = _a.right, bottom = _a.bottom, left = _a.left;
    var _b = (0, $klreC.getPosition)(evt), x = _b.x, y = _b.y;
    var res = {
        x: 0,
        y: 0
    };
...
parcelRequire.register("c9N4F", function(module, exports) {

$parcel$export(module.exports, "touchHandler", function () { return $8d9c646832a6fde4$export$2916e5349c3e671c; });
parcelRequire("ihaPO");
var $kgU8P = parcelRequire("kgU8P");
var $6Rgzf = parcelRequire("6Rgzf");
var $8d9c646832a6fde4$var$activeScrollbar;
function $8d9c646832a6fde4$export$2916e5349c3e671c(scrollbar) {
    var target = scrollbar.options.delegateTo || scrollbar.containerEl;
    var touchRecord = new (0, $kgU8P.TouchRecord)();
    var addEvent = (0, $6Rgzf.eventScope)(scrollbar);
    var damping;
    var pointerCount = 0;
    ...
    addEvent(target, "touchmove", function(evt) {
        if ($8d9c646832a6fde4$var$activeScrollbar && $8d9c646832a6fde4$var$activeScrollbar !== scrollbar) return;
        touchRecord.update(evt);
        var _a = touchRecord.getDelta(), x = _a.x, y = _a.y;
        scrollbar.addTransformableMomentum(x, y, evt, function(willScroll) {
            if (willScroll && evt.cancelable) {
                evt.preventDefault();
                $8d9c646832a6fde4$var$activeScrollbar = scrollbar;
            }
        });
    });
    addEvent(target, "touchcancel touchend", function(evt) {
        ...
        $8d9c646832a6fde4$var$activeScrollbar = null;
    });
}

});

parcelRequire.register("jpfs0", function(module, exports) {

$parcel$export(module.exports, "wheelHandler", function () { return $e20c56557ffdf4e3$export$14c83f6c8045ea84; });
parcelRequire("ihaPO");
var $6Rgzf = parcelRequire("6Rgzf");
function $e20c56557ffdf4e3$export$14c83f6c8045ea84(scrollbar) {
    var addEvent = (0, $6Rgzf.eventScope)(scrollbar);
    var target = scrollbar.options.delegateTo || scrollbar.containerEl;
    var eventName = "onwheel" in window || document.implementation.hasFeature("Events.wheel", "3.0") ? "wheel" : "mousewheel";
    addEvent(target, eventName, function(evt) {
        var _a = $e20c56557ffdf4e3$var$normalizeDelta(evt), x = _a.x, y = _a.y;
        scrollbar.addTransformableMomentum(x, y, evt, function(willScroll) {
            if (willScroll) evt.preventDefault();
        });
    });
...
var $e20c56557ffdf4e3$var$DELTA_SCALE = {
    STANDARD: 1,
    OTHERS: -3
};
var $e20c56557ffdf4e3$var$DELTA_MODE = [
    1.0,
    28.0,
    500.0
];
var $e20c56557ffdf4e3$var$getDeltaMode = function(mode) {
    return $e20c56557ffdf4e3$var$DELTA_MODE[mode] || $e20c56557ffdf4e3$var$DELTA_MODE[0];
};
function $e20c56557ffdf4e3$var$normalizeDelta(evt) {
    if ("deltaX" in evt) {
        var mode = $e20c56557ffdf4e3$var$getDeltaMode(evt.deltaMode);
        return {
            x: evt.deltaX / $e20c56557ffdf4e3$var$DELTA_SCALE.STANDARD * mode,
            y: evt.deltaY / $e20c56557ffdf4e3$var$DELTA_SCALE.STANDARD * mode
        };
    }
    if ("wheelDeltaX" in evt) return {
        x: evt.wheelDeltaX / $e20c56557ffdf4e3$var$DELTA_SCALE.OTHERS,
        y: evt.wheelDeltaY / $e20c56557ffdf4e3$var$DELTA_SCALE.OTHERS
    };
    // ie with touchpad
    return {
        x: 0,
        y: evt.wheelDelta / $e20c56557ffdf4e3$var$DELTA_SCALE.OTHERS
    };
}
...
parcelRequire.register("fRyUO", function(module, exports) {

$parcel$export(module.exports, "attachStyle", function () { return $b8c6e3b7b44a155b$export$ff76c51b0f744e0a; });
$parcel$export(module.exports, "detachStyle", function () { return $b8c6e3b7b44a155b$export$11939e4e3dfbbb72; });
var $b8c6e3b7b44a155b$var$TRACK_BG = "rgba(222, 222, 222, .75)";
var $b8c6e3b7b44a155b$var$THUMB_BG = "rgba(0, 0, 0, .5)";
// sets content's display type to `flow-root` to suppress margin collapsing
var $b8c6e3b7b44a155b$var$SCROLLBAR_STYLE = "\n[data-scrollbar] {\n  display: block;\n  position: relative;\n}\n\n.scroll-content {\n  display: flow-root;\n  -webkit-transform: translate3d(0, 0, 0);\n          transform: translate3d(0, 0, 0);\n}\n\n.scrollbar-track {\n  position: absolute;\n  opacity: 0;\n  z-index: 1;\n  background: " + $b8c6e3b7b44a155b$var$TRACK_BG + ";\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  -webkit-transition: opacity 0.5s 0.5s ease-out;\n          transition: opacity 0.5s 0.5s ease-out;\n}\n.scrollbar-track.show,\n.scrollbar-track:hover {\n  opacity: 1;\n  -webkit-transition-delay: 0s;\n          transition-delay: 0s;\n}\n\n.scrollbar-track-x {\n  bottom: 0;\n  left: 0;\n  width: 100%;\n  height: 8px;\n}\n.scrollbar-track-y {\n  top: 0;\n  right: 0;\n  width: 8px;\n  height: 100%;\n}\n.scrollbar-thumb {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 8px;\n  height: 8px;\n  background: " + $b8c6e3b7b44a155b$var$THUMB_BG + ";\n  border-radius: 4px;\n}\n";
var $b8c6e3b7b44a155b$var$STYLE_ID = "smooth-scrollbar-style";
var $b8c6e3b7b44a155b$var$isStyleAttached = false;
function $b8c6e3b7b44a155b$export$ff76c51b0f744e0a() {
    if ($b8c6e3b7b44a155b$var$isStyleAttached || typeof window === "undefined") return;
    var styleEl = document.createElement("style");
    styleEl.id = $b8c6e3b7b44a155b$var$STYLE_ID;
    styleEl.textContent = $b8c6e3b7b44a155b$var$SCROLLBAR_STYLE;
    if (document.head) document.head.appendChild(styleEl);
    $b8c6e3b7b44a155b$var$isStyleAttached = true;
}
function $b8c6e3b7b44a155b$export$11939e4e3dfbbb72() {
    if (!$b8c6e3b7b44a155b$var$isStyleAttached || typeof window === "undefined") return;
    var styleEl = document.getElementById($b8c6e3b7b44a155b$var$STYLE_ID);
    if (!styleEl || !styleEl.parentNode) return;
    styleEl.parentNode.removeChild(styleEl);
    $b8c6e3b7b44a155b$var$isStyleAttached = false;
}

});


parcelRequire.register("4h5Gm", function(module, exports) {

$parcel$export(module.exports, "ScrollbarModalPlugin", function () { return $31cd28592578cfeb$export$d1895f44da2d87ca; });

var $gYEFX = parcelRequire("gYEFX");
parcelRequire("4qafb");
var $9SjjN = parcelRequire("9SjjN");
class $31cd28592578cfeb$export$d1895f44da2d87ca extends (0, $9SjjN.ScrollbarPlugin) {
...
(0, $gYEFX.default)($31cd28592578cfeb$export$d1895f44da2d87ca, "pluginName", "modal");
(0, $gYEFX.default)($31cd28592578cfeb$export$d1895f44da2d87ca, "defaultOptions", {
    open: false
});

});
parcelRequire.register("gYEFX", function(module, exports) {

$parcel$export(module.exports, "default", function () { return $b9bdf98af2c3ca41$export$2e2bcd8739ae039; });
...
parcelRequire.register("3XZr1", function(module, exports) {

$parcel$export(module.exports, "ScrollbarScreenStopPlugin", function () { return $2e36897c617eec3e$export$627047b99c13ccfa; });

var $gYEFX = parcelRequire("gYEFX");
parcelRequire("4qafb");
var $9SjjN = parcelRequire("9SjjN");
class $2e36897c617eec3e$export$627047b99c13ccfa extends (0, $9SjjN.ScrollbarPlugin) {
...
(0, $gYEFX.default)($2e36897c617eec3e$export$627047b99c13ccfa, "pluginName", "screenStop");
(0, $gYEFX.default)($2e36897c617eec3e$export$627047b99c13ccfa, "defaultOptions", {
    points: []
});
...
parcelRequire.register("h8x9E", function(module, exports) {

$parcel$export(module.exports, "gsap", function () { return $c79ce6d7448420a8$export$99ee26438460406a; });

var $i0Kpg = parcelRequire("i0Kpg");

var $7uEDB = parcelRequire("7uEDB");
var $c79ce6d7448420a8$export$99ee26438460406a = (0, $i0Kpg.gsap).registerPlugin((0, $7uEDB.CSSPlugin)) || (0, $i0Kpg.gsap), // to protect from tree shaking
$c79ce6d7448420a8$export$7b23975ad686bf91 = $c79ce6d7448420a8$export$99ee26438460406a.core.Tween;

});
parcelRequire.register("i0Kpg", function(module, exports) {

$parcel$export(module.exports, "_config", function () { return $d1cc397620177a52$export$4922bee768729a77; });
$parcel$export(module.exports, "_isString", function () { return $d1cc397620177a52$export$f664476fd67145ca; });
$parcel$export(module.exports, "_isUndefined", function () { return $d1cc397620177a52$export$a8178c063a9fd3a1; });
$parcel$export(module.exports, "_numExp", function () { return $d1cc397620177a52$export$b9d44bb6523120d6; });
$parcel$export(module.exports, "_numWithUnitExp", function () { return $d1cc397620177a52$export$65c88bbd597e7b0a; });
$parcel$export(module.exports, "_relExp", function () { return $d1cc397620177a52$export$5a680e28b0b61bc; });
$parcel$export(module.exports, "gsap", function () { return $d1cc397620177a52$export$99ee26438460406a; });
$parcel$export(module.exports, "_missingPlugin", function () { return $d1cc397620177a52$export$7fb54635790b59a5; });
$parcel$export(module.exports, "_plugins", function () { return $d1cc397620177a52$export$d305d8ec5d7c26b8; });
$parcel$export(module.exports, "GSCache", function () { return $d1cc397620177a52$export$cf10981d5419cad5; });
$parcel$export(module.exports, "_getCache", function () { return $d1cc397620177a52$export$8b9be379d2de2a39; });
$parcel$export(module.exports, "_getProperty", function () { return $d1cc397620177a52$export$51d6bbe898aef1f9; });
$parcel$export(module.exports, "_forEachName", function () { return $d1cc397620177a52$export$f9000b814859f126; });
$parcel$export(module.exports, "_round", function () { return $d1cc397620177a52$export$9c8d725d65e13f94; });
$parcel$export(module.exports, "_parseRelative", function () { return $d1cc397620177a52$export$dac762bc6301b560; });
$parcel$export(module.exports, "_ticker", function () { return $d1cc397620177a52$export$762ed8fbedb691e3; });
$parcel$export(module.exports, "getUnit", function () { return $d1cc397620177a52$export$65f2564e9a9b9222; });
$parcel$export(module.exports, "_replaceRandom", function () { return $d1cc397620177a52$export$d5962a97e3cde94d; });
$parcel$export(module.exports, "_getSetter", function () { return $d1cc397620177a52$export$d60fbc1e0278aaf0; });
$parcel$export(module.exports, "PropTween", function () { return $d1cc397620177a52$export$3a67f7f44b1e838a; });
$parcel$export(module.exports, "_colorExp", function () { return $d1cc397620177a52$export$dd733e62515be2bd; });
$parcel$export(module.exports, "_colorStringFilter", function () { return $d1cc397620177a52$export$7eb2e5eb5eeb96a4; });
$parcel$export(module.exports, "_renderComplexString", function () { return $d1cc397620177a52$export$c5bc8e04394ecb2; });
$parcel$export(module.exports, "_checkPlugin", function () { return $d1cc397620177a52$export$5c457b74208010cf; });
$parcel$export(module.exports, "_sortPropTweensByPriority", function () { return $d1cc397620177a52$export$eed5824f53346d57; });
...
$d1cc397620177a52$export$dac762bc6301b560 = function _parseRelative(start, value) {
    ...
    $d1cc397620177a52$var$_lazyTweens.length && !$d1cc397620177a52$var$_reverting && $d1cc397620177a52$var$_lazyRender();
    animation.render(time, suppressEvents, force || $d1cc397620177a52$var$_reverting && time < 0 && (animation._initted || animation._startAt));
    $d1cc397620177a52$var$_lazyTweens.length && !$d1cc397620177a52$var$_reverting && $d1cc397620177a52$var$_lazyRender(); //in case rendering caused any tweens to lazy-init, we should render them because typically when someone calls seek() or time() or progress(), they expect an immediate render.
    ...
    if (!tl || keyframes && !vars.stagger) {
        ...
        if (startAt) {
            $d1cc397620177a52$var$_removeFromParent(tween._startAt = $d1cc397620177a52$export$208a41d6b4e37b97.set(targets, $d1cc397620177a52$export$dc2b19673bb53610({
                ...
                lazy: !prevStartAt && $d1cc397620177a52$var$_isNotFalse(lazy),
                startAt: null,
                delay: 0,
                onUpdate: onUpdate,
        ...
        } else if (runBackwards && dur) //from() tweens must be handled uniquely: their beginning values must be rendered but we don't want overwriting to occur yet (when time is still 0). Wait until the tween actually begins before doing all the routines like overwriting. At that time, we should render at the END of the tween to ensure that things initialize correctly (remember, from() tweens go backwards)
        {
            if (!prevStartAt) {
                ...
                p = $d1cc397620177a52$export$dc2b19673bb53610({
                    ...
                    lazy: immediateRender && !prevStartAt && $d1cc397620177a52$var$_isNotFalse(lazy),
...
$d1cc397620177a52$export$208a41d6b4e37b97.version = $d1cc397620177a52$export$e6a97ba2cae5bb94.version = $d1cc397620177a52$export$99ee26438460406a.version = "3.11.4";
...
parcelRequire.register("7uEDB", function(module, exports) {

$parcel$export(module.exports, "CSSPlugin", function () { return $574adb8b27817578$export$855822f522f18eef; });
/*!
 * CSSPlugin 3.11.4
 * https://greensock.com
 *
...
$574adb8b27817578$var$_renderRoundedCSSProp = function _renderRoundedCSSProp(ratio, data) {
    ...
    if ($574adb8b27817578$var$_windowExists() && window.document) {
        ...
        $574adb8b27817578$var$_reverting = (0, $i0Kpg.gsap).core.reverting;
...
$574adb8b27817578$var$_removeProperty = function _removeProperty(target, property) {
    ...
    var pt = new (0, $i0Kpg.PropTween)(plugin._pt, target, property, 0, 1, onlySetAtEnd ? $574adb8b27817578$var$_renderNonTweeningValueOnlyAtEnd : $574adb8b27817578$var$_renderNonTweeningValue);
    plugin._pt = pt;
    pt.b = beginning;
    pt.e = end;
...
$574adb8b27817578$var$_convertToUnit = function _convertToUnit(target, property, value, unit) {
    ...
    if ((toPercent || curUnit === "%") && ($574adb8b27817578$var$_transformProps[property] || ~property.indexOf("adius"))) {
        ...
        return (0, $i0Kpg._round)(toPercent ? curValue / px * amount : curValue / 100 * px);
    }
    ...
    cache = parent._gsap;
    if (cache && toPercent && cache.width && horizontal && cache.time === (0, $i0Kpg._ticker).time && !cache.uncache) return (0, $i0Kpg._round)(curValue / cache.width * amount);
    else {
        ...
        if (horizontal && toPercent) {
            cache = (0, $i0Kpg._getCache)(parent);
            cache.time = (0, $i0Kpg._ticker).time;
            cache.width = parent[measureProperty];
        }
    }
    return (0, $i0Kpg._round)(toPixels ? px * curValue / amount : px && curValue ? amount / px * curValue : 0);
    ...
    var pt = new (0, $i0Kpg.PropTween)(this._pt, target.style, prop, 0, 1, (0, $i0Kpg._renderComplexString)), index = 0, matchIndex = 0, a, result, startValues, startNum, color, startValue, endValue, endNum, chunk, endUnit, startUnit, endValues;
    pt.b = start;
    pt.e = end;
    start += ""; // ensure values are strings
    end += "";
    ...
    (0, $i0Kpg._colorStringFilter)(a); // pass an array with the starting and ending values and let the filter do whatever it needs to the values. If colors are found, it returns true and then we must match where the color shows up order-wise because for things like boxShadow, sometimes the browser provides the computed values with the color FIRST, but the user provides it with the color LAST, so flip them if necessary. Same for drop-shadow().
    start = a[0];
    end = a[1];
    startValues = start.match((0, $i0Kpg._numWithUnitExp)) || [];
    endValues = end.match((0, $i0Kpg._numWithUnitExp)) || [];
    if (endValues.length) {
        while(result = (0, $i0Kpg._numWithUnitExp).exec(end)){
            endValue = result[0];
            chunk = end.substring(index, result.index);
            if (color) color = (color + 1) % 5;
            ...
            if (endValue !== (startValue = startValues[matchIndex++] || "")) {
                ...
                endValue.charAt(1) === "=" && (endValue = (0, $i0Kpg._parseRelative)(startNum, endValue) + startUnit);
                endNum = parseFloat(endValue);
                endUnit = endValue.substr((endNum + "").length);
                index = (0, $i0Kpg._numWithUnitExp).lastIndex - endUnit.length;
                if (!endUnit) {
                    //if something like "perspective:300" is passed in and we must add a unit to the end
                    endUnit = endUnit || (0, $i0Kpg._config).units[prop] || startUnit;
                    if (index === end.length) {
                        end += endUnit;
                        pt.e += endUnit;
                    }
    ...
    (0, $i0Kpg._relExp).test(end) && (pt.e = 0); //if the end string contains relative values or dynamic random(...) values, delete the end it so that on the final render we don't actually set it to the string with += or -= characters (forces it to use the calculated value).
...
$574adb8b27817578$var$_specialProps = {
    clearProps: function clearProps(plugin, target, property, endValue, tween) {
        if (tween.data !== "isFromStart") {
            var pt = plugin._pt = new (0, $i0Kpg.PropTween)(plugin._pt, target, property, 0, 0, $574adb8b27817578$var$_renderClearProps);
            pt.u = endValue;
            pt.pr = -10;
            pt.tween = tween;
            plugin._props.push(property);
 ...
 */ $574adb8b27817578$var$_identity2DMatrix = [
    ...
    return $574adb8b27817578$var$_isNullTransform(matrixString) ? $574adb8b27817578$var$_identity2DMatrix : matrixString.substr(7).match((0, $i0Kpg._numExp)).map((0, $i0Kpg._round));
}, $574adb8b27817578$var$_getMatrix = function _getMatrix(target, force2D) {
    var cache = target._gsap || (0, $i0Kpg._getCache)(target), style = target.style, matrix = $574adb8b27817578$var$_getComputedTransformMatrixAsArray(target), parent, nextSibling, temp, addedToDOM;
    ...
    var cache = target._gsap || new (0, $i0Kpg.GSCache)(target);
    ...
    if (matrix !== $574adb8b27817578$var$_identity2DMatrix) {
        ...
        if (matrix.length === 6) {
            ...
            scaleX = (0, $i0Kpg._round)(Math.sqrt(a * a + b * b + c * c));
            scaleY = (0, $i0Kpg._round)(Math.sqrt(a22 * a22 + a32 * a32));
    ...
    cache.z = z + px;
    cache.scaleX = (0, $i0Kpg._round)(scaleX);
    cache.scaleY = (0, $i0Kpg._round)(scaleY);
    cache.rotation = (0, $i0Kpg._round)(rotation) + deg;
    cache.rotationX = (0, $i0Kpg._round)(rotationX) + deg;
    cache.rotationY = (0, $i0Kpg._round)(rotationY) + deg;
    ...
    cache.force3D = (0, $i0Kpg._config).force3D;
...
$574adb8b27817578$var$_addPxTranslate = function _addPxTranslate(target, start, value) {
    var unit = (0, $i0Kpg.getUnit)(start);
    return (0, $i0Kpg._round)(parseFloat(start) + parseFloat($574adb8b27817578$var$_convertToUnit(target, "x", value + "px", unit))) + unit;
    ...
    if (rotation || skewX) {
        ...
        a11 = (0, $i0Kpg._round)(a11);
        a21 = (0, $i0Kpg._round)(a21);
        a12 = (0, $i0Kpg._round)(a12);
        a22 = (0, $i0Kpg._round)(a22);
    } else {
        a11 = scaleX;
        a22 = scaleY;
        a21 = a12 = 0;
    ...
    if (xOrigin || yOrigin || xOffset || yOffset) {
        tx = (0, $i0Kpg._round)(tx + xOrigin - (xOrigin * a11 + yOrigin * a12) + xOffset);
        ty = (0, $i0Kpg._round)(ty + yOrigin - (xOrigin * a21 + yOrigin * a22) + yOffset);
    }
    if (xPercent || yPercent) {
        //The SVG spec doesn't support percentage-based translation in the "transform" attribute, so we merge it into the translation to simulate it.
        temp = target.getBBox();
        tx = (0, $i0Kpg._round)(tx + xPercent / 100 * temp.width);
        ty = (0, $i0Kpg._round)(ty + yPercent / 100 * temp.height);
    }
    ...
    var cap = 360, isString = (0, $i0Kpg._isString)(endValue), endNum = parseFloat(endValue) * (isString && ~endValue.indexOf("rad") ? $574adb8b27817578$var$_RAD2DEG : 1), change = endNum - startNum, finalValue = startNum + change + "deg", direction, pt;
    if (isString) {
    ...
    plugin._pt = pt = new (0, $i0Kpg.PropTween)(plugin._pt, target, property, startNum, change, $574adb8b27817578$var$_renderPropWithEnd);
    pt.e = finalValue;
    pt.u = "deg";
    plugin._props.push(property);
    return pt;
    ...
    for(p in $574adb8b27817578$var$_transformProps){
        ...
        if (startValue !== endValue && exclude.indexOf(p) < 0) {
            ...
            startUnit = (0, $i0Kpg.getUnit)(startValue);
            endUnit = (0, $i0Kpg.getUnit)(endValue);
            startNum = startUnit !== endUnit ? $574adb8b27817578$var$_convertToUnit(target, p, startValue, endUnit) : parseFloat(startValue);
            endNum = parseFloat(endValue);
            plugin._pt = new (0, $i0Kpg.PropTween)(plugin._pt, endCache, p, startNum, endNum - startNum, $574adb8b27817578$var$_renderCSSProp);
...
(0, $i0Kpg._forEachName)("padding,margin,Width,Radius", function(name, index) {
...
var $574adb8b27817578$export$855822f522f18eef = {
    ...
    init: function init(target, vars, tween, index, targets) {
        ...
        for(p in vars){
            ...
            endValue = vars[p];
            if ((0, $i0Kpg._plugins)[p] && (0, $i0Kpg._checkPlugin)(p, vars, tween, index, target, targets)) continue;
            ...
            if (type === "string" && ~endValue.indexOf("random(")) endValue = (0, $i0Kpg._replaceRandom)(endValue);
            if (specialProp) specialProp(this, target, p, endValue, tween) && (hasPriority = 1);
            else if (p.substr(0, 2) === "--") {
                //CSS variable
                startValue = (getComputedStyle(target).getPropertyValue(p) + "").trim();
                endValue += "";
                (0, $i0Kpg._colorExp).lastIndex = 0;
                if (!(0, $i0Kpg._colorExp).test(startValue)) {
                ...
                if (startAt && p in startAt) {
                    ...
                    (0, $i0Kpg._isString)(startValue) && ~startValue.indexOf("random(") && (startValue = (0, $i0Kpg._replaceRandom)(startValue));
                    (0, $i0Kpg.getUnit)(startValue + "") || (startValue += (0, $i0Kpg._config).units[p] || (0, $i0Kpg.getUnit)($574adb8b27817578$var$_get(target, p)) || ""); // for cases when someone passes in a unitless value like {x: 100}; if we try setting translate(100, 0px) it won't work.
                ...
                if (isTransformRelated) {
                    ...
                    if (!transformPropTween) {
                        ...
                        transformPropTween = this._pt = new (0, $i0Kpg.PropTween)(this._pt, style, $574adb8b27817578$var$_transformProp, 0, 1, cache.renderTransform, cache, 0, -1); //the first time through, create the rendering PropTween so that it runs LAST (in the linked list, we keep adding to the beginning)
                        transformPropTween.dep = 1; //flag it as dependent so that if things get killed/overwritten and this is the only PropTween left, we can safely kill the whole tween.
                    }
                    if (p === "scale") {
                        this._pt = new (0, $i0Kpg.PropTween)(this._pt, cache, "scaleY", cache.scaleY, (relative ? (0, $i0Kpg._parseRelative)(cache.scaleY, relative + endNum) : endNum) - cache.scaleY || 0, $574adb8b27817578$var$_renderCSSProp);
                        this._pt.u = 0;
                        props.push("scaleY", p);
                        p += "X";
                        ...
                        $574adb8b27817578$var$_addRotationalPropTween(this, cache, p, startNum, relative ? (0, $i0Kpg._parseRelative)(startNum, relative + endValue) : endValue);
                        continue;
                ...
                if (isTransformRelated || (endNum || endNum === 0) && (startNum || startNum === 0) && !$574adb8b27817578$var$_complexExp.test(endValue) && p in style) {
                    ...
                    endUnit = (0, $i0Kpg.getUnit)(endValue) || (p in (0, $i0Kpg._config).units ? (0, $i0Kpg._config).units[p] : startUnit);
                    startUnit !== endUnit && (startNum = $574adb8b27817578$var$_convertToUnit(target, p, startValue, endUnit));
                    this._pt = new (0, $i0Kpg.PropTween)(this._pt, isTransformRelated ? cache : style, p, startNum, (relative ? (0, $i0Kpg._parseRelative)(startNum, relative + endNum) : endNum) - startNum, !isTransformRelated && (endUnit === "px" || p === "zIndex") && vars.autoRound !== false ? $574adb8b27817578$var$_renderRoundedCSSProp : $574adb8b27817578$var$_renderCSSProp);
                    ...
                    this.add(target, p, startValue || target[p], relative ? relative + endValue : endValue, index, targets);
                        ...
                        (0, $i0Kpg._missingPlugin)(p, endValue);
                        continue;
                    }
        ...
        hasPriority && (0, $i0Kpg._sortPropTweensByPriority)(this);
    },
    render: function render(ratio, data) {
...
(0, $i0Kpg.gsap).utils.checkPrefix = $574adb8b27817578$export$8cbef5dd49a09c8b;
(0, $i0Kpg.gsap).core.getStyleSaver = $574adb8b27817578$var$_getStyleSaver;
(function(positionAndScale, rotation, others, aliases) {
    var all = (0, $i0Kpg._forEachName)(positionAndScale + "," + rotation + "," + others, function(name) {
        $574adb8b27817578$var$_transformProps[name] = 1;
    });
    (0, $i0Kpg._forEachName)(rotation, function(name) {
        (0, $i0Kpg._config).units[name] = "deg";
        $574adb8b27817578$var$_rotationalProperties[name] = 1;
    });
    $574adb8b27817578$var$_propertyAliases[all[13]] = positionAndScale + "," + rotation;
    (0, $i0Kpg._forEachName)(aliases, function(name) {
        var split = name.split(":");
        $574adb8b27817578$var$_propertyAliases[split[1]] = all[split[0]];
    });
})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent", "rotation,rotationX,rotationY,skewX,skewY", "transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", "0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");
(0, $i0Kpg._forEachName)("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective", function(name) {
    (0, $i0Kpg._config).units[name] = "px";
});
(0, $i0Kpg.gsap).registerPlugin($574adb8b27817578$export$855822f522f18eef);
...
$parcel$export(module.exports, "updateOneState", function () { return $11c42eabf89ba9f0$export$408e72d428e64956; });
...
let $11c42eabf89ba9f0$var$globalState = {
    ...
    nameError: (0, $1A24E.el)("#formRef .errorMessageName").dataset.error_required,
    companyError: (0, $1A24E.el)("#formRef .errorMessageCompany").dataset.error_required,
    emailError: (0, $1A24E.el)("#formRef .errorMessageEmail").dataset.error_required,
    phoneError: (0, $1A24E.el)("#formRef .errorMessagePhone").dataset.error_required
};
...
function $11c42eabf89ba9f0$export$4971331372cec95a(newState) {
    ...
    $11c42eabf89ba9f0$var$listeners.all.forEach((fn)=>fn($11c42eabf89ba9f0$var$globalState));
}
function $11c42eabf89ba9f0$export$408e72d428e64956(key, object) {
    $11c42eabf89ba9f0$var$globalState[key] = object;
    $11c42eabf89ba9f0$var$listeners[key].forEach((fn)=>fn($11c42eabf89ba9f0$var$globalState));
}
function $11c42eabf89ba9f0$export$50fdfeece43146fd() {
    return $11c42eabf89ba9f0$var$globalState;
}
function $11c42eabf89ba9f0$export$7d0529cae993db76(fn, ...keys) {
    if (keys) for (let item of keys){
        if ($11c42eabf89ba9f0$var$listeners[item].indexOf(fn) === -1) $11c42eabf89ba9f0$var$listeners[item].push(fn);
        fn($11c42eabf89ba9f0$var$globalState[item]);
    }
    else {
        if ($11c42eabf89ba9f0$var$listeners.all.indexOf(fn) === -1) $11c42eabf89ba9f0$var$listeners.all.push(fn);
        fn($11c42eabf89ba9f0$var$globalState);
    }
}
function $11c42eabf89ba9f0$export$f500693cef883ffd(fn, ...keys) {
    if (keys) for (let key of keys){
        const index = $11c42eabf89ba9f0$var$listeners[key].indexOf(fn);
        if (index !== -1) $11c42eabf89ba9f0$var$listeners[key].splice(index, 1);
    }
    else {
        const index1 = $11c42eabf89ba9f0$var$listeners.all.indexOf(fn);
        if (index1 !== -1) $11c42eabf89ba9f0$var$listeners.all.splice(index1, 1);
    }
}

});
parcelRequire.register("1A24E", function(module, exports) {

$parcel$export(module.exports, "el", function () { return $846a10ab5ec300c3$export$c3da0dad1b44eea9; });
$parcel$export(module.exports, "els", function () { return $846a10ab5ec300c3$export$7236b418e6d031e1; });
function $846a10ab5ec300c3$export$c3da0dad1b44eea9(selector) {
    return document.querySelector(selector);
}
function $846a10ab5ec300c3$export$7236b418e6d031e1(selector) {
...
let $7fc88b69fd18bc46$var$isDebugMode = false;
if (typeof window !== "undefined") $7fc88b69fd18bc46$var$isDebugMode = !!localStorage?.getItem("isDebugMode");
function $7fc88b69fd18bc46$export$2d3d93e556461272(scrollerEl, triggerEl, updateHandler) {
    return (id, startFromTop, endFromTop, scrollerStart = "top", scrollerEnd = "top", elStart = "top", elEnd = "top")=>{
        const trigger = (0, $gISqU.ScrollTrigger).create({
            id: id,
            markers: $7fc88b69fd18bc46$var$isDebugMode && id.indexOf("Horizontal") === -1 ? {
                startColor: "red",
                endColor: "orange",
                fontSize: "18px"
            } : false,
...
function $7fc88b69fd18bc46$export$9ba0048c63cbc3aa(bodyScrollBar) {
    if ($7fc88b69fd18bc46$var$isDebugMode) bodyScrollBar.addListener(({ offset: offset  })=>{
        (0, $h8x9E.gsap).set([
...
function $22230737f0397950$export$798047c433103370(elements) {
    return {
...
function $22230737f0397950$export$864492cc36471f19(allScreensEl) {
    let resizeDetectorFn = (first)=>{
        const last = $22230737f0397950$export$798047c433103370(allScreensEl);
    ...
    resizeDetectorFn = resizeDetectorFn.bind(null, $22230737f0397950$export$798047c433103370(allScreensEl));
...
let $ea4b4ec0dcd1ce2a$var$viewportHeight;
const $ea4b4ec0dcd1ce2a$var$FIRST_OFFSET = 200;
const $ea4b4ec0dcd1ce2a$var$OVERLAP = 300;
let $ea4b4ec0dcd1ce2a$var$bodyScrollBar;
let $ea4b4ec0dcd1ce2a$var$onScrollToSection;
let $ea4b4ec0dcd1ce2a$var$videoOverlap = 0;
let $ea4b4ec0dcd1ce2a$var$screen1Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen2Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen3Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen3HorizontalTween = [];
let $ea4b4ec0dcd1ce2a$var$screen4Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen5Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen5HorizontalTween = [];
let $ea4b4ec0dcd1ce2a$var$screen6Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen7Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen8Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen8HorizontalTween = [];
let $ea4b4ec0dcd1ce2a$var$screen9Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen10Tween = [];
let $ea4b4ec0dcd1ce2a$var$screen11Tween = [];
let $ea4b4ec0dcd1ce2a$var$topContainerRef;
let $ea4b4ec0dcd1ce2a$var$scrollContainerRef;
let $ea4b4ec0dcd1ce2a$var$ghostRef;
let $ea4b4ec0dcd1ce2a$var$headerRef;
let $ea4b4ec0dcd1ce2a$var$chelkaRef;
let $ea4b4ec0dcd1ce2a$var$screen1Ref;
let $ea4b4ec0dcd1ce2a$var$screen2Ref;
let $ea4b4ec0dcd1ce2a$var$screen3Ref;
let $ea4b4ec0dcd1ce2a$var$screen3SliderRef;
let $ea4b4ec0dcd1ce2a$var$headerScreen3Ref;
let $ea4b4ec0dcd1ce2a$var$screen4Ref;
let $ea4b4ec0dcd1ce2a$var$screen5Ref;
let $ea4b4ec0dcd1ce2a$var$screen5SliderRef;
let $ea4b4ec0dcd1ce2a$var$screen6Ref;
let $ea4b4ec0dcd1ce2a$var$screen7Ref;
let $ea4b4ec0dcd1ce2a$var$screen8Ref;
let $ea4b4ec0dcd1ce2a$var$screen8SliderRef;
let $ea4b4ec0dcd1ce2a$var$screen9Ref;
let $ea4b4ec0dcd1ce2a$var$screen10Ref;
let $ea4b4ec0dcd1ce2a$var$screen11Ref;
let $ea4b4ec0dcd1ce2a$var$footerRef;
let $ea4b4ec0dcd1ce2a$var$submitButtonRef;
let $ea4b4ec0dcd1ce2a$var$followCursorRef;
let $ea4b4ec0dcd1ce2a$var$commonScreens;
let $ea4b4ec0dcd1ce2a$var$footerScreens;
let $ea4b4ec0dcd1ce2a$var$allScreens;
let $ea4b4ec0dcd1ce2a$var$setIsHeaderVisibleGlobal;
// id -> scrollDistance
let $ea4b4ec0dcd1ce2a$var$scrollDistance = new Map();
let $ea4b4ec0dcd1ce2a$var$startScreenNavigationPositions = new Map();
function $ea4b4ec0dcd1ce2a$export$f22da7240b7add18() {
    function addScreenNavigationPosition(id, height) {
        $ea4b4ec0dcd1ce2a$var$startScreenNavigationPositions.set(id, height);
    }
    function getScreenNavigationPosition(screenId) {
        return $ea4b4ec0dcd1ce2a$var$startScreenNavigationPositions.get(screenId);
    }
    function initWindowStaff() {
        window.history.scrollRestoration = "manual";
        $ea4b4ec0dcd1ce2a$var$videoOverlap = (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen2Ref) * 0.2;
    }
    function scrollAnimationHandler(trigger) {
        if (trigger.vars.id === "screen1") {
            if (!$ea4b4ec0dcd1ce2a$var$screen1Tween.length) {
                $ea4b4ec0dcd1ce2a$var$screen1Tween.push((0, $h8x9E.gsap).to($ea4b4ec0dcd1ce2a$var$screen2Ref, {
                    top: `+=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen1") - $ea4b4ec0dcd1ce2a$var$videoOverlap}px`,
                    paused: true,
                    ease: "none"
                }));
                [
                    $ea4b4ec0dcd1ce2a$var$screen3Ref,
                    ...$ea4b4ec0dcd1ce2a$var$commonScreens,
                    ...$ea4b4ec0dcd1ce2a$var$footerScreens
                ].forEach((screen)=>{
                    $ea4b4ec0dcd1ce2a$var$screen1Tween.push((0, $h8x9E.gsap).to(screen, {
                        top: `+=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen1") - $ea4b4ec0dcd1ce2a$var$videoOverlap - $ea4b4ec0dcd1ce2a$var$videoOverlap / 3}px`,
                        paused: true,
                        ease: "none"
                    }));
                });
            }
            $ea4b4ec0dcd1ce2a$var$screen1Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen3Horizontal") {
            if (!$ea4b4ec0dcd1ce2a$var$screen3HorizontalTween.length) [
                $ea4b4ec0dcd1ce2a$var$screen3Ref,
                ...$ea4b4ec0dcd1ce2a$var$commonScreens,
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen3HorizontalTween.push((0, $h8x9E.gsap).to(screen, {
                    top: `+=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen3Horizontal")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen3HorizontalTween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen3") {
            if (!$ea4b4ec0dcd1ce2a$var$screen3Tween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens,
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen3Tween.push((0, $h8x9E.gsap).to(screen, {
                    top: `-=${(0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen4Ref)}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen3Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen4") {
            if (!$ea4b4ec0dcd1ce2a$var$screen4Tween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens.slice(1),
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen4Tween.push((0, $h8x9E.gsap).to(screen, {
                    top: `-=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen4")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen4Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen5Horizontal") {
            if (!$ea4b4ec0dcd1ce2a$var$screen5HorizontalTween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens.slice(1),
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen5HorizontalTween.push((0, $h8x9E.gsap).to(screen, {
                    top: `+=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen5Horizontal")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen5HorizontalTween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen5") {
            if (!$ea4b4ec0dcd1ce2a$var$screen5Tween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens.slice(2),
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen5Tween.push((0, $h8x9E.gsap).to(screen, {
                    top: `-=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen5")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen5Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen6") {
            if (!$ea4b4ec0dcd1ce2a$var$screen6Tween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens.slice(3),
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen6Tween.push((0, $h8x9E.gsap).to(screen, {
                    top: `-=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen6")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen6Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen7") {
            if (!$ea4b4ec0dcd1ce2a$var$screen7Tween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens.slice(4),
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen7Tween.push((0, $h8x9E.gsap).to(screen, {
                    top: `-=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen7")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen7Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen8Horizontal") {
            if (!$ea4b4ec0dcd1ce2a$var$screen8HorizontalTween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens.slice(4),
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen8HorizontalTween.push((0, $h8x9E.gsap).to(screen, {
                    top: `+=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen8Horizontal")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen8HorizontalTween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen8") {
            if (!$ea4b4ec0dcd1ce2a$var$screen8Tween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens.slice(5),
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen8Tween.push((0, $h8x9E.gsap).to(screen, {
                    top: `-=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen8")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen8Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen9") {
            if (!$ea4b4ec0dcd1ce2a$var$screen9Tween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens.slice(6),
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen9Tween.push((0, $h8x9E.gsap).to(screen, {
                    top: `-=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen9")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen9Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen10") {
            if (!$ea4b4ec0dcd1ce2a$var$screen10Tween.length) [
                ...$ea4b4ec0dcd1ce2a$var$commonScreens.slice(7),
                ...$ea4b4ec0dcd1ce2a$var$footerScreens
            ].forEach((screen)=>{
                $ea4b4ec0dcd1ce2a$var$screen10Tween.push((0, $h8x9E.gsap).to(screen, {
                    top: `-=${$ea4b4ec0dcd1ce2a$var$scrollDistance.get("screen10")}px`,
                    paused: true,
                    ease: "none"
                }));
            });
            $ea4b4ec0dcd1ce2a$var$screen10Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
        if (trigger.vars.id === "screen11") {
            if (!$ea4b4ec0dcd1ce2a$var$screen11Tween.length) $ea4b4ec0dcd1ce2a$var$screen11Tween.push((0, $h8x9E.gsap).to($ea4b4ec0dcd1ce2a$var$footerRef, {
                top: `+=${(0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$footerRef)}px`,
                paused: true,
                ease: "none"
            }));
            if (trigger.progress < 0.3 && window.innerWidth > 1440) (0, $h8x9E.gsap).set($ea4b4ec0dcd1ce2a$var$screen10Ref, {
                backgroundColor: ""
            });
            if (trigger.progress > 0.6) {
                if (window.innerWidth > 1440) (0, $h8x9E.gsap).set($ea4b4ec0dcd1ce2a$var$screen10Ref, {
                    backgroundColor: getComputedStyle(window.document.body).getPropertyValue("--black")
                });
                (0, $h8x9E.gsap).to($ea4b4ec0dcd1ce2a$var$screen11Ref, {
                    scale: trigger.direction === 1 ? 0.9 : 1,
                    ease: "power2.out"
                });
                (0, $h8x9E.gsap).to($ea4b4ec0dcd1ce2a$var$submitButtonRef, {
                    xPercent: trigger.direction === 1 ? -5 : 5,
                    y: trigger.direction === 1 ? -((0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen11Ref) * 0.1) / 2 : 0,
                    ease: "power2.out"
                });
            }
            $ea4b4ec0dcd1ce2a$var$screen11Tween.forEach((tween)=>tween.totalProgress(trigger.progress));
        }
    }
    function initScrollTriggers() {
        let scrollTriggers = {};
        const createScrollTrigger = (0, $7fc88b69fd18bc46$export$2d3d93e556461272)($ea4b4ec0dcd1ce2a$var$topContainerRef, $ea4b4ec0dcd1ce2a$var$scrollContainerRef, scrollAnimationHandler);
        let viewportDiff = 0;
        // -----------video wrappers screens--------------
        let startScreen1 = 0;
        let endScreen1 = startScreen1 + (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen1Ref);
        ...
        $ea4b4ec0dcd1ce2a$var$scrollDistance.set("screen1", screen1Distance);
        $ea4b4ec0dcd1ce2a$var$scrollDistance.set("screen2", (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen2Ref) - $ea4b4ec0dcd1ce2a$var$videoOverlap / 3);
        // next
        let deltaStart3 = (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen3Ref) > $ea4b4ec0dcd1ce2a$var$viewportHeight + 120 ? (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen3Ref) - $ea4b4ec0dcd1ce2a$var$viewportHeight - 120 : 0;
        let startScreen3Horizontal = endScreen1 + (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen2Ref) - 2 * $ea4b4ec0dcd1ce2a$var$videoOverlap / 3 + deltaStart3;
        let screen3Circles = (0, $1A24E.els)("#screen3 .slider .circle");
        ...
        screen3Circles.forEach((circle, index)=>{
            ...
            (0, $h8x9E.gsap).set(circle, {
                x: screen3CircleWidth * index - offset * index
            });
            screen3Accumulator += screen3CircleWidth - offset;
        });
        let endScreen3Horizontal = window.innerWidth > 900 && !(0, $ix1dx.isTouchDevice)() ? startScreen3Horizontal + screen3Accumulator - (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen3SliderRef) : startScreen3Horizontal;
        ...
        $ea4b4ec0dcd1ce2a$var$scrollDistance.set("screen3Horizontal", screen3HorizontalDistance);
        addScreenNavigationPosition("screen3", startScreen3Horizontal);
        const screenIdEnter = `screen3Enter`;
        const startScreenEnterTrigger = getScreenNavigationPosition("screen3") - $ea4b4ec0dcd1ce2a$var$viewportHeight / 3;
        const screenEnterTrigger = createScrollTrigger(screenIdEnter, startScreenEnterTrigger, startScreenEnterTrigger + 100);
        // next
        let elHeight = (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen4Ref);
        let startScreen3 = endScreen3Horizontal;
        let endScreen3 = startScreen3 + ((0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen3Ref) - elHeight) - deltaStart3;
        ...
        $ea4b4ec0dcd1ce2a$var$scrollDistance.set("screen3", screen3Distance);
        // -----------video wrappers screens--------------
        // other
        let lastEndScrollTrigger = endScreen3;
        let endScrollHorizontalTrigger = 0;
        let screenId;
        $ea4b4ec0dcd1ce2a$var$commonScreens.forEach((screenRef, index)=>{
            let screenStartPosition;
            screenId = `screen${index + 4}`;
            const viewportCutOffset = (0, $ix1dx.calcOverflowOffset)(screenRef, $ea4b4ec0dcd1ce2a$var$viewportHeight);
            let startScreenHorizontalTrigger = 0;
            let deltaStart8 = (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen8Ref) > $ea4b4ec0dcd1ce2a$var$viewportHeight + 60 ? (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen8Ref) - $ea4b4ec0dcd1ce2a$var$viewportHeight - 60 : 0;
            if (screenId === "screen5" || screenId === "screen8") {
                ...
                let screen8Circles = (0, $1A24E.els)("#screen8 .slider .circle");
                ...
                const distance = screenId === "screen5" ? (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen5SliderRef) : window.innerWidth > 900 && !(0, $ix1dx.isTouchDevice)() ? screen8Accumulator - (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen3SliderRef) : 0;
                ...
                $ea4b4ec0dcd1ce2a$var$scrollDistance.set(screenIdHorizontal, horizontalDistance);
                scrollTriggers = {
                    ...scrollTriggers,
            ...
            elHeight = (0, $ix1dx.height)(screenRef);
            ...
            $ea4b4ec0dcd1ce2a$var$scrollDistance.set(screenId, distance1);
            const screenIdEnter = `${screenId}Enter`;
            const startScreenEnterTrigger = getScreenNavigationPosition(screenId) - $ea4b4ec0dcd1ce2a$var$viewportHeight / 3;
        ...
        addScreenNavigationPosition("footer", lastEndScrollTrigger + (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen11Ref) + (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$footerRef) - $ea4b4ec0dcd1ce2a$var$viewportHeight);
        screenId = `screen11Enter`;
        const startScreen11EnterTrigger = getScreenNavigationPosition("screen11") - $ea4b4ec0dcd1ce2a$var$viewportHeight / 3;
        ...
        screenId = `screen11`;
        const extraDistance = $ea4b4ec0dcd1ce2a$var$viewportHeight > (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen11Ref) ? ($ea4b4ec0dcd1ce2a$var$viewportHeight - (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen11Ref)) / 2 : 0;
        const startScreen11Trigger = lastEndScrollTrigger + (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen11Ref) + extraDistance;
        const endScreen11Trigger = startScreen11Trigger + (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$footerRef);
        const screen11Trigger = createScrollTrigger(screenId, startScreen11Trigger, endScreen11Trigger, "bottom", "bottom");
        $ea4b4ec0dcd1ce2a$var$scrollDistance.set("screen11", endScreen11Trigger - startScreen11Trigger);
        scrollTriggers = {
            ...scrollTriggers,
            [screenId]: screen11Trigger
        };
        (0, $gkwRL.updateOneState)("scrollTriggers", scrollTriggers);
    }
    function initScreensPositions() {
        let offsetAccumulator = 0;
        (0, $h8x9E.gsap).set($ea4b4ec0dcd1ce2a$var$screen1Ref, {
            top: offsetAccumulator
        });
        offsetAccumulator = $ea4b4ec0dcd1ce2a$var$videoOverlap;
        (0, $h8x9E.gsap).set($ea4b4ec0dcd1ce2a$var$screen2Ref, {
            top: `${offsetAccumulator}px`
        });
        offsetAccumulator += (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen2Ref) - $ea4b4ec0dcd1ce2a$var$videoOverlap / 3;
        (0, $h8x9E.gsap).set($ea4b4ec0dcd1ce2a$var$screen3Ref, {
            top: `${offsetAccumulator}px`
        });
        offsetAccumulator += (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen3Ref);
        [
            ...$ea4b4ec0dcd1ce2a$var$commonScreens,
            $ea4b4ec0dcd1ce2a$var$screen11Ref
        ].forEach((screen, index)=>{
            (0, $h8x9E.gsap).set(screen, {
                top: `${offsetAccumulator}px`
            });
            offsetAccumulator += screen.offsetHeight;
        });
        (0, $h8x9E.gsap).set($ea4b4ec0dcd1ce2a$var$submitButtonRef, {
        ...
        // put under form
        (0, $h8x9E.gsap).set($ea4b4ec0dcd1ce2a$var$footerRef, {
            top: `${offsetAccumulator - (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$footerRef)}px`
        });
        (0, $h8x9E.gsap).set($ea4b4ec0dcd1ce2a$var$ghostRef, {
            height: `${getScreenNavigationPosition("screen11") + (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$screen11Ref) + (0, $ix1dx.height)($ea4b4ec0dcd1ce2a$var$footerRef)}px`
        });
    }
   ...
   }*/ $ea4b4ec0dcd1ce2a$var$topContainerRef = (0, $1A24E.el)("#topContainerRef");
    $ea4b4ec0dcd1ce2a$var$scrollContainerRef = (0, $1A24E.el)("#scrollContainerRef");
    $ea4b4ec0dcd1ce2a$var$ghostRef = (0, $1A24E.el)("#ghostRef");
    $ea4b4ec0dcd1ce2a$var$headerRef = (0, $1A24E.el)("#header");
    $ea4b4ec0dcd1ce2a$var$chelkaRef = (0, $1A24E.el)("#chelkaRef");
    $ea4b4ec0dcd1ce2a$var$screen1Ref = (0, $1A24E.el)("#screen1");
    $ea4b4ec0dcd1ce2a$var$screen2Ref = (0, $1A24E.el)("#screen2");
    $ea4b4ec0dcd1ce2a$var$screen3Ref = (0, $1A24E.el)("#screen3");
    $ea4b4ec0dcd1ce2a$var$screen3SliderRef = (0, $1A24E.el)("#screen3 .sliderRef");
    let screen3circle = (0, $1A24E.el)("#screen3 .circle");
    $ea4b4ec0dcd1ce2a$var$headerScreen3Ref = (0, $1A24E.el)("#screen3 #headerScreen");
    $ea4b4ec0dcd1ce2a$var$screen4Ref = (0, $1A24E.el)("#screen4");
    $ea4b4ec0dcd1ce2a$var$screen5Ref = (0, $1A24E.el)("#screen5");
    $ea4b4ec0dcd1ce2a$var$screen5SliderRef = (0, $1A24E.el)("#screen5 #sliderRef");
    $ea4b4ec0dcd1ce2a$var$screen6Ref = (0, $1A24E.el)("#screen6");
    $ea4b4ec0dcd1ce2a$var$screen7Ref = (0, $1A24E.el)("#screen7");
    $ea4b4ec0dcd1ce2a$var$screen8Ref = (0, $1A24E.el)("#screen8");
    $ea4b4ec0dcd1ce2a$var$screen8SliderRef = (0, $1A24E.el)("#screen8 .sliderRef");
    $ea4b4ec0dcd1ce2a$var$screen9Ref = (0, $1A24E.el)("#screen9");
    $ea4b4ec0dcd1ce2a$var$screen10Ref = (0, $1A24E.el)("#screen10");
    $ea4b4ec0dcd1ce2a$var$screen11Ref = (0, $1A24E.el)("#screen11");
    $ea4b4ec0dcd1ce2a$var$footerRef = (0, $1A24E.el)("#footer");
    $ea4b4ec0dcd1ce2a$var$submitButtonRef = (0, $1A24E.el)("#submit-button");
    $ea4b4ec0dcd1ce2a$var$followCursorRef = (0, $1A24E.el)("#cursor");
    $ea4b4ec0dcd1ce2a$var$onScrollToSection = (section)=>{
        const duration = 2000;
        switch(section){
            case "about":
                $ea4b4ec0dcd1ce2a$var$bodyScrollBar.scrollTo(0, getScreenNavigationPosition("screen3"), false);
                break;
            case "technology":
                $ea4b4ec0dcd1ce2a$var$bodyScrollBar.scrollTo(0, getScreenNavigationPosition("screen5"), false);
                break;
            case "applying":
                $ea4b4ec0dcd1ce2a$var$bodyScrollBar.scrollTo(0, getScreenNavigationPosition("screen7"), false);
                break;
            case "bennefits":
                $ea4b4ec0dcd1ce2a$var$bodyScrollBar.scrollTo(0, getScreenNavigationPosition("screen8"), false);
                break;
            case "projects":
                $ea4b4ec0dcd1ce2a$var$bodyScrollBar.scrollTo(0, getScreenNavigationPosition("screen9"), false);
                break;
            case "steps":
                $ea4b4ec0dcd1ce2a$var$bodyScrollBar.scrollTo(0, getScreenNavigationPosition("screen10"), false);
                break;
            case "contacts":
                $ea4b4ec0dcd1ce2a$var$bodyScrollBar.scrollTo(0, getScreenNavigationPosition("screen11"), false);
                break;
            case "form":
                $ea4b4ec0dcd1ce2a$var$bodyScrollBar.scrollTo(0, getScreenNavigationPosition("screen11"), false);
                break;
            case "top":
                $ea4b4ec0dcd1ce2a$var$bodyScrollBar.scrollTo(0, 0, duration);
                break;
        }
    };
    (0, $gkwRL.selectState)((newState)=>{
        $ea4b4ec0dcd1ce2a$var$onScrollToSection((0, $gkwRL.getState)().scrollPage);
    }, "scrollPage");
    $ea4b4ec0dcd1ce2a$var$topContainerRef.addEventListener("mousemove", (e)=>handleCursorFolowMove(e), false);
    const handleCursorFolowMove = (e)=>{
        const target = e.target;
        if (!target) return;
        $ea4b4ec0dcd1ce2a$var$followCursorRef.style.left = +e.pageX + "px";
        $ea4b4ec0dcd1ce2a$var$followCursorRef.style.top = $ea4b4ec0dcd1ce2a$var$ghostRef.scrollTop + e.pageY + "px";
    };
    $ea4b4ec0dcd1ce2a$var$footerScreens = [
        $ea4b4ec0dcd1ce2a$var$screen11Ref,
        $ea4b4ec0dcd1ce2a$var$footerRef,
        $ea4b4ec0dcd1ce2a$var$submitButtonRef
    ];
    $ea4b4ec0dcd1ce2a$var$commonScreens = [
        $ea4b4ec0dcd1ce2a$var$screen4Ref,
        $ea4b4ec0dcd1ce2a$var$screen5Ref,
        $ea4b4ec0dcd1ce2a$var$screen6Ref,
        $ea4b4ec0dcd1ce2a$var$screen7Ref,
        $ea4b4ec0dcd1ce2a$var$screen8Ref,
        $ea4b4ec0dcd1ce2a$var$screen9Ref,
        $ea4b4ec0dcd1ce2a$var$screen10Ref
    ];
    $ea4b4ec0dcd1ce2a$var$allScreens = [
        $ea4b4ec0dcd1ce2a$var$screen1Ref,
        $ea4b4ec0dcd1ce2a$var$screen2Ref,
        $ea4b4ec0dcd1ce2a$var$screen3Ref,
        ...$ea4b4ec0dcd1ce2a$var$commonScreens,
        ...$ea4b4ec0dcd1ce2a$var$footerScreens
    ];
    initWindowStaff();
    $ea4b4ec0dcd1ce2a$var$bodyScrollBar = (0, $9eyNG.initSmoothScrollbar)($ea4b4ec0dcd1ce2a$var$topContainerRef);
    (0, $h8x9E.gsap).context(()=>{
        $ea4b4ec0dcd1ce2a$var$viewportHeight = window.innerHeight;
        initScrollTriggers();
        initScreensPositions();
        (0, $7fc88b69fd18bc46$export$9ba0048c63cbc3aa)($ea4b4ec0dcd1ce2a$var$bodyScrollBar);
    }, $ea4b4ec0dcd1ce2a$var$topContainerRef.current);
    (0, $22230737f0397950$export$864492cc36471f19)($ea4b4ec0dcd1ce2a$var$allScreens.map((screenRef)=>screenRef));
    $ea4b4ec0dcd1ce2a$var$bodyScrollBar.updatePluginOptions("modal", {
        open: false
    });
    $ea4b4ec0dcd1ce2a$var$bodyScrollBar.updatePluginOptions("screenStop", {
        points: Array.from($ea4b4ec0dcd1ce2a$var$startScreenNavigationPositions.values())
    });
}
(0, $ix1dx.onDomReady)($ea4b4ec0dcd1ce2a$export$f22da7240b7add18);
