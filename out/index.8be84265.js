...
parcelRequire.register("26ov3", function(module, exports) {
...
function $c72e5eebb2db52b5$export$f22da7240b7add18() {
    const sliders = (0, $7Hbkn.els)(".slider");
    for(let ii = 0; ii < sliders.length; ii++){
        ...
        let endDragTween;
        let scrollTrigger = (0, $dfMDe.getState)().scrollTriggers[`screen${slider.dataset.block}Horizontal`];
        let enterScrollTrigger = (0, $dfMDe.getState)().scrollTriggers[`screen${slider.dataset.block}Enter`];
        ...
        (0, $l6B09.gsap).registerPlugin((0, $kcA29.ScrollTrigger), (0, $26ov3.Draggable));
        (0, $l6B09.gsap).context(()=>{
            let allCircles = (0, $l6B09.gsap).utils.toArray(slider.querySelectorAll(".circle"));
        ...
        const indicatorChange = (id)=>{
            (0, $l6B09.gsap).context(()=>{
                if (id !== indicatorActive) {
                    (0, $l6B09.gsap).fromTo(slider.querySelector(`.indicator-${id}`), {
                        x: -12,
                        y: 24,
                        opacity: 0,
                        ease: "back.out(1.7)",
                    ...
                    (0, $l6B09.gsap).to(slider.querySelector(`.indicator-${indicatorActive}`), {
                        x: 12,
                        y: -24,
                        opacity: 0,
                        ease: "back.out(1.7)",
        ...
        function onScrollTriggersReady() {
            const handlerIndicatorMouseEnter = (id)=>{
                if (window.innerWidth > 900 && !(0, $jbrIz.isTouchDevice)() && id !== indicatorActive) (0, $l6B09.gsap).context(()=>{
                    (0, $l6B09.gsap).fromTo(slider.querySelector(`.indicator-${id}`), {
                        x: -12,
                        y: 24,
                        opacity: 0,
            ...
            const handlerIndicatorMouseLeave = (id)=>{
                if (window.innerWidth > 900 && !(0, $jbrIz.isTouchDevice)() && id !== indicatorActive) (0, $l6B09.gsap).context(()=>{
                    (0, $l6B09.gsap).to(slider.querySelector(`.indicator-${id}`), {
                        x: 12,
                        y: -24,
                        opacity: 0,
                        ease: "back.out(1.7)",
            ...
            const handlerIndicatorClick = (id)=>{
                const mapperX = (0, $l6B09.gsap).utils.mapRange(0, (circleWidth - overlap) * (slides.length * 2 - 1), 0, 1);
                (0, $l6B09.gsap).to(timeline, {
                    progress: mapperX(2 * id * (circleWidth - overlap)),
                    ease: "power4.out",
                    onComplete: ()=>{
                        window.innerWidth > 900 && !(0, $jbrIz.isTouchDevice)() && scrollTrigger.scroll(breakpoints[id]);
                        indicatorUpdate();
                    }
                });
            };
            const indicatorUpdate = ()=>{
                const mapperX = (0, $l6B09.gsap).utils.mapRange(0, (circleWidth - overlap) * (2 * slides.length - 1), 0, 1);
            ...
            timeline = window.innerWidth > 900 && !(0, $jbrIz.isTouchDevice)() ? (0, $l6B09.gsap).timeline({
                paused: true,
                scrollTrigger: scrollTrigger,
                ease: "none"
            }) : (0, $l6B09.gsap).timeline({
                paused: true,
                ease: "none"
            });
            ...
            const mapperX = window.innerWidth > 900 && !(0, $jbrIz.isTouchDevice)() ? (0, $l6B09.gsap).utils.mapRange(0, scrollTrigger?.end - scrollTrigger?.start, 0, 1) : (0, $l6B09.gsap).utils.mapRange(0, (circleWidth - overlap) * (slides.length * 2 - 1), 0, 1);
            ...
            const updateTimeline = (e)=>{
                ...
                let nextPosition = window.innerWidth > 900 && !(0, $jbrIz.isTouchDevice)() ? scrollProgress - moveDelta : progress - mapperX(moveDelta);
                if (!moveDelta) return;
            ...
            const endDragHandle = (e)=>{
                ...
                if (e.clientX - startDrag > 0) {
                    if (window.innerWidth > 900 && !(0, $jbrIz.isTouchDevice)()) {
                        for(let j = 0; j < breakpoints.length; j++)if (scrollTrigger.scroll() > breakpoints[j] && scrollTrigger.scroll() < breakpoints[j + 1]) endDragTween = (0, $l6B09.gsap).to(timeline, {
                        ...
                        for(let i = 0; i < slides.length; i++)if (timeline.progress() > mapperX(i * 2 * (circleWidth - overlap)) && timeline.progress() < mapperX((i + 1) * 2 * (circleWidth - overlap))) endDragTween = (0, $l6B09.gsap).to(timeline, {
                    ...
                    if (window.innerWidth > 900 && !(0, $jbrIz.isTouchDevice)()) {
                        for(let j1 = 1; j1 < breakpoints.length; j1++)if (scrollTrigger.scroll() < breakpoints[j1] && scrollTrigger.scroll() > breakpoints[j1 - 1]) {
                            if (j1 === breakpoints.length - 1) endDragTween = (0, $l6B09.gsap).to(timeline, {
                                progress: 1,
                                duration: 0.8,
                                ease: "power1.out",
                                onComplete: ()=>{
                            ...
                            else endDragTween = (0, $l6B09.gsap).to(timeline, {
                        ...
                        if (timeline.progress() < mapperX(i1 * 2 * (circleWidth - overlap)) && timeline.progress() > mapperX((i1 - 1) * 2 * (circleWidth - overlap))) endDragTween = (0, $l6B09.gsap).to(timeline, {
                            progress: mapperX(i1 * 2 * (circleWidth - overlap)),
                            ease: "power1.out",
                            duration: 0.8,
                            onComplete: indicatorUpdate
                        });
                        if (timeline.progress() > mapperX(i1 * 2 * (circleWidth - overlap))) endDragTween = (0, $l6B09.gsap).to(timeline, {
                            progress: 1,
                            ease: "power1.out",
                            duration: 0.8,
                            onComplete: indicatorUpdate
            ...
            (0, $26ov3.Draggable).create(slider.querySelector(".drag"), {
                type: "x",
                trigger: sliderRef,
                duration: 0.4,
                ease: "power4.out",
        ...
        enterTimeline = (0, $l6B09.gsap).timeline({
            paused: true,
...
(0, $jbrIz.onDomReady)($c72e5eebb2db52b5$export$f22da7240b7add18);
